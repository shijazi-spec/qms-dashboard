...
const WalaPlusNav = {
  ...
  navigationGroups: [
    ...
    // audits + risk/oversight.
    {
      ...
      // (Sarah 2026-07-29). Was 'indigo', which isn't in getColorClasses and
    ...
    },
    {
      ...
      items: [
        ...
        { label: 'Certification Milestones', href: '/certification-milestones', icon: 'check-circle', id: 'compliance' },
