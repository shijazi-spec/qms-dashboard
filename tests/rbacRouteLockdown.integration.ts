...
const TEST_USERS = [
  {
    email: "rbac-lock-viewer@rbac-test.invalid",
    role: "department_viewer",
    name: "RBAC Lock Viewer",
  },
  {
    email: "rbac-lock-executive@rbac-test.invalid",
    role: "executive",
    name: "RBAC Lock Executive",
  },
  {
    email: "rbac-lock-qm@rbac-test.invalid",
    role: "quality_manager",
    name: "RBAC Lock QM",
  },
  {
    email: "rbac-lock-admin@rbac-test.invalid",
    role: "admin",
    name: "RBAC Lock Admin",
  },
  {
    email: "rbac-lock-hoq@rbac-test.invalid",
