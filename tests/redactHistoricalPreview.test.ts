...
{
  const GHP_TOKEN = "ghp_AAAABBBBCCCCDDDDEEEEFFFFGGGGHHHH1234";
  const previewWithLeak = `Approve GitHub deploy for repo walaplus/api — token=${GHP_TOKEN}`;
...
// ---------------------------------------------------------------------------
{
  const SK_KEY = "sk_live_AbCdEfGhIjKlMnOpQrStUvWx9876";
  const GHP2 = "ghp_ZZZZYYYYYXXXXWWWWVVVVUUUUTTTTSSSS9999";
