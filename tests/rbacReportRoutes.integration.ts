...
const TEST_USERS = [
  {
    email: "rbac-test-viewer@rbac-test.invalid",
    role: "department_viewer",
    name: "RBAC Test Viewer",
  },
  {
    email: "rbac-test-executive@rbac-test.invalid",
    role: "executive",
...
async function main(): Promise<void> {
  ...
  try {
    const viewerCookie = makeSessionCookie(
      "rbac-test-viewer@rbac-test.invalid",
      "department_viewer"
    );
    const executiveCookie = makeSessionCookie(
      "rbac-test-executive@rbac-test.invalid",
      "executive"
    );
