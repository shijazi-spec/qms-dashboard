 ...
 *
 * Usage:
 *   QC_BASE_URL=https://qms-dashboard.replit.app npx tsx tests/qc/run-platform-qc.ts
...
function writeMdReport(results: QCResult[], baseUrl: string): void {
  ...
  let md = `# WalaPlus Platform QC Report\n\n`;
...
async function main(): Promise<void> {
  ...
  console.log("🔍 WalaPlus Platform QC – testing against:", baseUrl);
  console.log("");
