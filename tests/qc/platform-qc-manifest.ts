 ...
 *
 * Aligned with: User Guide (qms-dashboard.replit.app/guide) + Scope of Work
 */
...
/** Base URL for API (e.g. http://localhost:5000 or https://qms-dashboard.replit.app) */
export const getBaseUrl = (): string =>
  process.env.QC_BASE_URL || process.env.PLATFORM_URL || "http://localhost:5000";
...
export const PLATFORM_QC_MANIFEST: QCTestCase[] = [
  ...
  {
    id: "qms-dashboard",
    screenName: "QMS Dashboard",
    screenRoute: "/qms",
    functionalityName: "QMS dashboard data",
    method: "GET",
