...
const MFA_SECRET_UUID = "5f8f5f74-1c3e-4a5f-8b7c-9d4f2a1b6e83";
...
// =============================================================================
{
  ...
  const initial: ELRow[] = [
    ...
    // case the live path fixed in Task #684.
    {
      ...
      new_value: {
        ...
        raw_payload: JSON.stringify({ api_key: "sk_uuid_only_no_shape" }),
      },
    },
  ];
  ...
  assert(
    typeof row2.new_value.raw_payload === "string" &&
      !row2.new_value.raw_payload.includes("sk_uuid_only_no_shape"),
