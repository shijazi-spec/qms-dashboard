...
const FIXTURES: SecretFixture[] = [
  {
    ...
    secret: '$2b$12$abcdefghijklmnopqrstuv1234567890ABCDEFGHIJKLMNOPQRSTU',
  ...
  },
  {
    ...
    secret: 'sk-live-NEVER_PERSIST_ME_1234567890abcdefghijklmnop',
  ...
  },
  {
    ...
    secret: 'pk_live_51HxYzABCDefGHijKLmnoPqRStuVw',
    marker: 'pk_live_51HxYzABCDef',
    field: 'description',
  },
  {
    patternName: 'github',
    description: 'GitHub ghp_… personal access token embedded in a note',
    secret: 'ghp_topsecretrefreshtokenabcdefghijklmnoXYZ',
    marker: 'ghp_topsecretrefreshtoken',
    field: 'note',
  },
  {
    patternName: 'gitlab',
    description: 'GitLab glpat-… token embedded in a note',
    secret: 'glpat-abcdefghijklmnopqrst12',
  ...
  },
  {
    ...
    secret: 'ya29.A0AfH6SMBabcdefghijklmnopqrstuv',
  ...
  },
  {
    ...
    secret: 'Bearer abcdefghij1234567890ABCDEFGHIJKLMNOP',
