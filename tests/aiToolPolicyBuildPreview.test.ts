...
const SECRETS = {
  ...
  apiKey: "sk-live-NEVER_PERSIST_ME_1234567890abcdefghij",
  // github regex requires:  gh[porsu]_[A-Za-z0-9]{30,}
  ghPat: "ghp_LEAKDETECTORBUILDPREVIEWaaaaaaaaaaaaaaaaaaaaa",
...
function buildPayloadWithSecretsFor(
  ...
  return {
    ...
    sourceReference: `https://logs.example.com/?token=${SECRETS.ghPat}`,
    ...
    evidenceUrl: `https://files.example.com/?sig=${SECRETS.jwt}`,
    score: 95,
    action: "create",
  ...
  for (const policy of policies) {
    ...
    try {
      await enqueuePendingAction({
        ...
        requestedByUserId: 1,
        requestedByEmail: "qa@example.com",
