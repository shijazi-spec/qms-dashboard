...
const SECRET_KEY    = "sk-live-INTEGRATION_LEAK_PROMPT_KEY_ABCDEFGHIJKLMNOP";
const SECRET_GH     = "ghp_integrationLeakedToolInput1234567890abcdef";
const SECRET_BCRYPT = "$2b$12$abcdefghijklmnopqrstuv1234567890ABCDEFGHIJKLMNOPQRSTU";
const SECRET_JWT =
  "eyJhbGciOiJIUzI1NiJ9.eyJzdWIiOiJpbnRlZ3JhdGlvbi03Nzc3In0.SflKxwRJSMeKKF2QT4fwpMeJf36POk6yJV_adQssw5c";
