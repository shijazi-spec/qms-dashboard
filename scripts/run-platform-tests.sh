...
KEY="X-Admin-Key: ${ADMIN_API_KEY:-WalaPlus-QMS-Admin-2026}"
...
echo "============================================================"
echo "  WalaPlus Platform Test Runner — $TS"
echo "  Target: $BASE"
echo "============================================================"
...
_t3_code=$(curl -s -o /dev/null -m 10 -w "%{http_code}" http://localhost:5000/api/admin/scorecards)
