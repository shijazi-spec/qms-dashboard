...
(async () => {
  ...
  const rows = [
    ...
    ['Mohammed Ghanem',        413, 0,   413, '2019-08-05', '2026-04-19',   -1, 'Active',   'Sales / Account Manager', '-',                        'Partner Active(236), Contacted(111)',  '268,300'],
    ...
    ['Ahmad Alfheer',          106, 0,   106, '2020-05-18', '2026-04-19',   -1, 'Active',   'Sales / Account Manager', '-',                        'New Deal(58), Partner Active(48)',     '1,353,086'],
    ['Ahmed Aldukheel',         46, 0,    46, '2019-08-22', '2022-06-08', 1410, 'Inactive', 'Sales / Account Manager', '-',                        'Partner Active(44), Signed(1)',        '25,200'],
    ...
    ['Mohammed Ridha',          10, 10,    0, '2023-08-06', '2025-12-03',  136, 'Inactive', 'SDR / Lead Generation',   'Outbound(6), Referral(3)', '-',                                    '-'],
    ...
    ['Mohammed Alhumoudi',       1, 1,     0, '2024-08-21', '2025-09-29',  201, 'Inactive', 'SDR / Lead Generation',   'Search Engine(1)',         '-',                                    '-'],
    ['Mohammed Fouad',           1, 0,     1, '2020-03-27', '2025-01-23',  450, 'Inactive', 'Sales / Account Manager', '-',                        'Meeting(1)',                           '5,000'],
    ['Abdullah Alsaeed',         1, 0,     1, '2022-02-09', '2022-03-01', 1509, 'Inactive', 'Sales / Account Manager', '-',                        'Partner Active(1)',                    '2,000'],
  ];
  ...
  const lines = [
    'WalaPlus - Missing CRM Owners with Activity Profile (2026-04-19)',
    '',
    ...
    '  - Mohammed Ridha: already in seed roster but with team = Unassigned. Please set his real team.',
    ...
    '  - Names with double-spaces (Khalil  Aldadah, Mohammed  Ghanem) and odd casing',
