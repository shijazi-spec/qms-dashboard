...
Week 5-6 Speaker Diarization + Talk-Time Analytics
         ...
         └─ Per-call: "Khalid 64% / Customer 36% — interrupted 3x"
...
|---|---|
| **8:00 AM** | Opens `qms-dashboard.replit.app/calls` (no email/digest involved) |
| 8:00:10 | Lands on the Overview tab with date filter set to "Last 7 days" |
| 8:00:30 | Scans KPI strip: 52 calls analyzed, team avg 71%, 3 new coaching plans |
| 8:01 | Scans leaderboard: Layla 91% (top), Khalid 62% (bottom, marked with "3 plans pending") |
| 8:01:30 | Clicks Khalid's row → expands inline |
