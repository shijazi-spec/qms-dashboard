...
`check-communication-eligibility` and registered on the WalaPlus SDR
...
Use it from agent chat: *"Should we reach out to alsahab.sa?"* → the
...
Defaults reflect WalaPlus's Zoho field layout: `Stage = "Agreement
