...
**Target:** https://qms-dashboard.replit.app
...
- **Verification:** Request from `https://evil-attacker.com` does NOT get reflected — response shows the app's own domain only.
...
**Prepared by:** WalaPlus Security Team
