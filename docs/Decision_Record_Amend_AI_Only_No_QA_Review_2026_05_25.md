...
**Decision-maker:** a.amashah@walaplus.com (Operations & Quality HOD)
...
Khalid    | 12 calls | 62% ↓ | 78% comp. | 1 critical | 1 plan pending
...
Layla     | 9 calls  | 91% ↑ | 100% comp. | 0 critical | 0 plans
...
• Mohammed — Discovery plan (3 failed-call evidence) — awaiting delivery for 5 days → [Nudge]
...
| Time | Action |
|---|---|
| 8:00 | Opens `qms-dashboard.replit.app/calls` → Weekly Report |
| 8:01 | Scans header + 8-week trend |
| 8:02 | Scans agent rows, sorted by gap-to-target |
| 8:03 | Clicks **Deliver** on Khalid's plan → coaching modal opens with evidence pre-loaded |
| 8:05 | Captures Khalid's commitment + follow-up date → **Mark Delivered** |
| 8:06 | Clicks **Deliver** on Mohammed's plan, same flow |
