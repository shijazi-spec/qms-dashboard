...
| Agent | Model | Status |
|---|---|---|
| WalaPlus QMS Consultant | gpt-4o | Production |
| WalaPlus Quality Specialist | gpt-4o | Production |
| WalaPlus Sales Quality Specialist | gpt-4o | Production |
| WalaPlus SDR Quality Specialist | gpt-4o | Production |
...
```
SELECT COUNT(*) FROM policies WHERE owner_name IS NULL OR owner_name='';
→ 154
...
→ 6 | 2026-04-18 13:46 UTC | healthy
→ 5 | 2026-04-18 13:00 UTC | healthy
→ 4 | 2026-04-18 12:51 UTC | critical
```
...
SELECT
  COUNT(*) FILTER (WHERE owner_name IS NULL OR owner_name='')        AS no_owner,
