...
**Date:** 2026-05-25
**Decision-makers:** a.amashah@walaplus.com (Operations & Quality HOD)
...
Fund **three new phases** in the Call Evaluation revamp plan to close the gaps between WalaPlus's in-house build and the Velents proposal Sarah originally validated with the CTO on Aug 17, 2025.
...
End state: WalaPlus's in-house build delivers functional parity with Velents's Aug 17 commitments, at zero vendor risk + zero data-residency exposure + full PDPL governance control.
...
- ❌ **BI exports** (Snowflake/Power BI) — only relevant if WalaPlus connects to a corporate data warehouse, which doesn't exist yet
...
- CTO Ahmed Eldaly — not yet briefed. Recommend a 30-min walkthrough of this doc + the gap analysis before starting P0, since the CTO originally approved the Velents-equivalent scope in Aug 2025 and this is the implementation choice for delivering against that approval.
