...
const SEED_DOCUMENTS: SeedDoc[] = [
  ...
  { code: 'WP-SOP-040', title: 'Annual Audit Programme Governance Process',                        category: 'quality',    documentType: 'sop', owner: 'Quality Management' },
  { code: 'WP-SOP-041', title: 'Off-Platform (Manual) Audit Intake and AI Extraction Process',     category: 'quality',    documentType: 'sop', owner: 'Quality Management' },
  { code: 'WP-SOP-042', title: 'External and Surveillance Audit Management Process',               category: 'compliance', documentType: 'sop', owner: 'GRC' },
  ...
  // -- Audit Governance (P0 Internal Audits re-architecture) --
  { code: 'WP-FORM-055', title: 'Annual Audit Programme Plan',                                     category: 'quality',    documentType: 'form', owner: 'Quality Management' },
  { code: 'WP-FORM-056', title: 'Manual Audit Intake Report Template',                             category: 'quality',    documentType: 'form', owner: 'Quality Management' },
  { code: 'WP-FORM-057', title: 'External Audit Readiness Checklist',                              category: 'compliance', documentType: 'form', owner: 'GRC' },
  ...
  // -- Audit Governance (P0 Internal Audits re-architecture) --
  { code: 'WP-CTL-007', title: 'Audit Programme Sign-off Control (HITL Gate)',                     category: 'governance', documentType: 'control', owner: 'Quality Management' },
];
