  ...
  execute: async () => {
    try {
      ...
      return {
        ...
        note: "Counts capped at 500/module. Empty accounts need a per-row attachment check before they become delete-eligible. The platform only tags Empty-Delete; the Zoho admin performs deletion. Orphaned deals are LINKED to an account, not deleted.",
      };
    } catch (e: any) {
