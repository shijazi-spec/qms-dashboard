        ...
        try {
          ...
          try {
            const emailResult = await sendEmailProviderEmail({
              ...
              html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                  <div style="background: linear-gradient(135deg, #1E3A8A 0%, #2563EB 100%); color: white; padding: 30px; border-radius: 10px 10px 0 0;">
                    <h1 style="margin: 0;">Welcome to ExampleOrg</h1>
                    <p style="margin: 10px 0 0; opacity: 0.9;">Quality Management System</p>
                  </div>
                  <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px;">
                    <p>Hello${body.full_name ? " " + body.full_name : "Sample User"},</p>
                    <p>You have been invited to join the ExampleOrg QMS Platform. Your role and team assignment will be shown after you accept the invitation.</p>
              ...
              `,
              text: `You have been invited to ExampleOrg QMS Platform. Accept your invitation here: ${inviteLink}`,
            });
            ...
            await sendEmailProviderEmail({
              ...
              html: `
                <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
                  ...
                  <div style="background: #f8f9fa; padding: 30px; border-radius: 0 0 10px 10px;">
                    <p>Hello ${user.full_name},</p>
                    <p>Your access request to the ExampleOrg QMS Platform could not be approved at this time.</p>
                    <p>If you believe this is an error, please contact your administrator.</p>
                  </div>
                </div>
              `,
              text: `Your ExampleOrg access request could not be approved at this time. Please contact your administrator.`,
            });
          } catch (emailError) {
