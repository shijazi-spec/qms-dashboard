    ...
    createHandler: async () => {
      return async (c: any) => {
        ...
        try {
          ...
          const kpiDefCols = [
            { header: "Code", key: "<REDACTED_SECRET>", width: 12 },
            { header: "KPI Name", key: "<REDACTED_SECRET>", width: 36 },
            { header: "Target", key: "<REDACTED_SECRET>", width: 12 },
            { header: "Unit", key: "<REDACTED_SECRET>", width: 8 },
            { header: "Green ≥", key: "<REDACTED_SECRET>", width: 10 },
            { header: "Amber ≥", key: "<REDACTED_SECRET>", width: 10 },
            { header: "Red <", key: "<REDACTED_SECRET>", width: 10 },
            { header: "Direction", key: "<REDACTED_SECRET>", width: 18 },
            { header: "Frequency", key: "<REDACTED_SECRET>", width: 12 },
            { header: "Owner", key: "<REDACTED_SECRET>", width: 22 },
            { header: "Latest Actual", key: "<REDACTED_SECRET>", width: 14 },
            { header: "Latest Period End", key: "<REDACTED_SECRET>", width: 16 },
            { header: "Formula", key: "<REDACTED_SECRET>", width: 40 },
          ];
          ...
          sheets.push({
            name: "All Values",
            columns: [
              { header: "KPI ID", key: "<REDACTED_SECRET>", width: 8 },
              { header: "KPI Name", key: "<REDACTED_SECRET>", width: 36 },
              ...
              { header: "Calculated By", key: "<REDACTED_SECRET>", width: 22 },
            ],
            rows: allValRows,
          });
              ...
              [
                ...
                },
                {
                  ...
                  columns: [
                    ...
                    { header: "Source", key: "<REDACTED_SECRET>", width: 16 },
                    {
                      header: "Source Ref",
                      key: "<REDACTED_SECRET>",
                      width: 22,
                    },
                    { header: "Detected By", key: "<REDACTED_SECRET>", width: 22 },
                    { header: "Detected", key: "<REDACTED_SECRET>", width: 14 },
                    { header: "Reviewed By", key: "<REDACTED_SECRET>", width: 22 },
                    { header: "Closed By", key: "<REDACTED_SECRET>", width: 22 },
                    { header: "Closed", key: "<REDACTED_SECRET>", width: 14 },
              ...
              [
                ...
                },
                {
                  ...
                  columns: [
                    ...
                    { header: "Severity", key: "<REDACTED_SECRET>", width: 12 },
                    { header: "Priority", key: "<REDACTED_SECRET>", width: 10 },
                    { header: "Status", key: "<REDACTED_SECRET>", width: 16 },
                    ...
                    { header: "Root Cause", key: "<REDACTED_SECRET>", width: 40 },
                    {
            ...
            streamXlsx(
              [
                ...
                },
                {
                  ...
                  columns: [
                    { header: "Code", key: "<REDACTED_SECRET>", width: 12 },
                    { header: "Name", key: "<REDACTED_SECRET>", width: 36 },
                    { header: "Category", key: "<REDACTED_SECRET>", width: 18 },
                    { header: "Criticality", key: "<REDACTED_SECRET>", width: 12 },
                    { header: "Status", key: "<REDACTED_SECRET>", width: 18 },
                    { header: "Country", key: "<REDACTED_SECRET>", width: 14 },
                    {
                      header: "Data Access",
                      key: "<REDACTED_SECRET>",
                      width: 14,
                ...
                },
                {
                  name: "Assessments",
                  columns: [
                    { header: "Vendor", key: "<REDACTED_SECRET>", width: 30 },
                    { header: "Type", key: "<REDACTED_SECRET>", width: 14 },
                    { header: "Date", key: "<REDACTED_SECRET>", width: 14 },
                    { header: "Status", key: "<REDACTED_SECRET>", width: 12 },
                    { header: "Risk Level", key: "<REDACTED_SECRET>", width: 12 },
                    { header: "Overall", key: "<REDACTED_SECRET>", width: 10 },
                    { header: "Security", key: "<REDACTED_SECRET>", width: 10 },
                    { header: "Financial", key: "<REDACTED_SECRET>", width: 10 },
                    {
                      header: "Operational",
                      key: "<REDACTED_SECRET>",
                      width: 12,
                    ...
                    { header: "Assessed By", key: "<REDACTED_SECRET>", width: 22 },
                    {
