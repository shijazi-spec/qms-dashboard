      ...
      return async (c: any) => {
        try {
          ...
          const buf = await generateFraudPdfReport({
            ...
            meta,
            columns: [
              { key: "<REDACTED_SECRET>", label: "Code", width: 70 },
              { key: "<REDACTED_SECRET>", label: "Clause / Control", width: 200 },
              { key: "<REDACTED_SECRET>", label: "Domain", width: 110 },
              { key: "<REDACTED_SECRET>", label: "Priority", width: 50 },
              { key: "<REDACTED_SECRET>", label: "Docs", width: 30, align: "right" },
              { key: "<REDACTED_SECRET>", label: "AI Verdict", width: 65 },
            ],
            ...
            footer:
              ...
              ` — Generated by ExampleOrg QMS Platform — Confidential`,
          });
      ...
      return async (c: any) => {
        try {
          ...
          const buf = await generateFraudPdfReport({
            ...
            meta,
            columns: [
              { label: "Clause", key: "<REDACTED_SECRET>", width: 90 },
              { label: "Domain", key: "<REDACTED_SECRET>", width: 100 },
              { label: "Outcome", key: "<REDACTED_SECRET>", width: 70 },
              { label: "Auditor Notes", key: "<REDACTED_SECRET>", width: 235 },
            ],
        ...
        try {
         ...
         LEFT JOIN LATERAL (
          ...
          const buf = await generateFraudPdfReport({
            ...
            columns: [
              { label: "Clause", key: "<REDACTED_SECRET>", width: 90 },
              { label: "Title", key: "<REDACTED_SECRET>", width: 165 },
              { label: "Domain", key: "<REDACTED_SECRET>", width: 90 },
              { label: "Priority", key: "<REDACTED_SECRET>", width: 60 },
              { label: "Status", key: "<REDACTED_SECRET>", width: 90 },
            ],
