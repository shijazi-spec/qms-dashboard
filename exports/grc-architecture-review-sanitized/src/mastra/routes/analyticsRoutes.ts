            ...
            [
              {
                name: "Summary",
                columns: [
                  { header: "Metric", key: "<REDACTED_SECRET>", width: 48 },
                  { header: "Value", key: "<REDACTED_SECRET>", width: 56 },
                ],
                rows: summaryRows,
              },
              {
                ...
                columns: [
                  { header: "Component", key: "<REDACTED_SECRET>", width: 44 },
                  { header: "Value (0-100)", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Weight", key: "<REDACTED_SECRET>", width: 10 },
                  { header: "Contribution", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Included", key: "<REDACTED_SECRET>", width: 10 },
                  { header: "Note / Inputs", key: "<REDACTED_SECRET>", width: 60 },
                ],
              ...
              },
              {
                name: "Digest Issues",
                columns: [
                  { header: "Module", key: "<REDACTED_SECRET>", width: 18 },
                  { header: "Issue Type", key: "<REDACTED_SECRET>", width: 40 },
                  { header: "Severity", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Count", key: "<REDACTED_SECRET>", width: 10 },
                ],
                rows: issueRows,
              },
              {
                name: "Audit Findings",
                columns: [
                  { header: "Finding #", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Criteria", key: "<REDACTED_SECRET>", width: 36 },
                  { header: "Dimension", key: "<REDACTED_SECRET>", width: 16 },
                  { header: "Severity", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Status", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Owner", key: "<REDACTED_SECRET>", width: 20 },
                  { header: "Target Date", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Resolved", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Created", key: "<REDACTED_SECRET>", width: 22 },
                ],
                rows: auditFindings,
              },
              {
                ...
                columns: [
                  { header: "NC #", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Title", key: "<REDACTED_SECRET>", width: 40 },
                  { header: "Type", key: "<REDACTED_SECRET>", width: 16 },
                  { header: "Severity", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Status", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Disposition", key: "<REDACTED_SECRET>", width: 16 },
                  { header: "Detected By", key: "<REDACTED_SECRET>", width: 20 },
                  { header: "Detected", key: "<REDACTED_SECRET>", width: 22 },
                  { header: "Closed", key: "<REDACTED_SECRET>", width: 22 },
                ],
                rows: ncRows,
              },
              {
                name: "CAPAs",
                columns: [
                  { header: "CAPA #", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Title", key: "<REDACTED_SECRET>", width: 40 },
                  { header: "Type", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Status", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Priority", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Assigned To", key: "<REDACTED_SECRET>", width: 20 },
                  { header: "Department", key: "<REDACTED_SECRET>", width: 18 },
                  { header: "Due Date", key: "<REDACTED_SECRET>", width: 22 },
                  { header: "Created", key: "<REDACTED_SECRET>", width: 22 },
                ],
                rows: capaRows,
              },
              {
                ...
                columns: [
                  ...
                  { header: "Title", key: "<REDACTED_SECRET>", width: 36 },
                  { header: "Category", key: "<REDACTED_SECRET>", width: 18 },
                  { header: "Level", key: "<REDACTED_SECRET>", width: 12 },
                  ...
                  { header: "Status", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Owner", key: "<REDACTED_SECRET>", width: 20 },
                  { header: "Treatment", key: "<REDACTED_SECRET>", width: 16 },
                  { header: "Treatment Deadline", key: "<REDACTED_SECRET>", width: 22 },
                  { header: "Identified", key: "<REDACTED_SECRET>", width: 22 },
                ],
                rows: riskRows,
              },
              {
                name: "KPIs",
                columns: [
                  { header: "KPI ID", key: "<REDACTED_SECRET>", width: 10 },
                  { header: "Period Start", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Period End", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Actual", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Target", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Status", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Trend", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Updated", key: "<REDACTED_SECRET>", width: 22 },
                ],
                rows: kpiRowsDetail,
              },
              {
                ...
                columns: [
                  { header: "ID", key: "<REDACTED_SECRET>", width: 8 },
                  { header: "Obligation", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "Assessed", key: "<REDACTED_SECRET>", width: 22 },
                  { header: "Assessed By", key: "<REDACTED_SECRET>", width: 20 },
                  { header: "Status", key: "<REDACTED_SECRET>", width: 18 },
                  { header: "Score", key: "<REDACTED_SECRET>", width: 8 },
                  { header: "Remediation Required", key: "<REDACTED_SECRET>", width: 18 },
                  { header: "Remediation Status", key: "<REDACTED_SECRET>", width: 18 },
                  { header: "Remediation Deadline", key: "<REDACTED_SECRET>", width: 22 },
                  { header: "Next Assessment", key: "<REDACTED_SECRET>", width: 22 },
                ],
                rows: complianceRows,
              },
              {
                ...
                columns: [
                  { header: "Audit Date", key: "<REDACTED_SECRET>", width: 22 },
                  { header: "Records Audited", key: "<REDACTED_SECRET>", width: 16 },
                  { header: "Issues Found", key: "<REDACTED_SECRET>", width: 14 },
                  { header: "People", key: "<REDACTED_SECRET>", width: 10 },
                  { header: "Process", key: "<REDACTED_SECRET>", width: 10 },
                  { header: "Governance", key: "<REDACTED_SECRET>", width: 12 },
                  { header: "Overall", key: "<REDACTED_SECRET>", width: 10 },
                ],
                rows: qaResults,
              },
            ],
            { title: "ExampleOrg Quality Audit Report" },
          );
