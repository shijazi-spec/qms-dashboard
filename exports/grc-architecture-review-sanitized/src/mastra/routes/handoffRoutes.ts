    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { getAllHandoffRules, initHandoffTables } =
            await import("../../utils/handoffDatabase");
          await initHandoffTables();

          const url = new URL(c.req.url);
          const source_module =
            url.searchParams.get("source_module") || undefined;
          ...
          safeLogger.error("❌ [HandoffAPI] Error fetching rules:", error);
  ...
  },
  {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const { getHandoffSummary, initHandoffTables } =
            await import("../../utils/handoffDatabase");
          await initHandoffTables();
          ...
          safeLogger.error("❌ [HandoffAPI] Error fetching summary:", error);
  ...
  },
  {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const { getHandoffEvents, initHandoffTables } =
            await import("../../utils/handoffDatabase");
          await initHandoffTables();
          ...
          safeLogger.error("❌ [HandoffAPI] Error fetching events:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const logger = mastra?.getLogger();
          const { createHandoffRule, initHandoffTables } =
            await import("../../utils/handoffDatabase");
          const { logEvent } = await import("../../utils/eventLogsDatabase");
          await initHandoffTables();

          const body = await c.req.json();
          logger?.info("📝 [HandoffAPI] POST /api/handoff/rules", {
            name: body.name,
          ...
          safeLogger.error("❌ [HandoffAPI] Error creating rule:", error);
          if (error.code === "23505") {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const logger = mastra?.getLogger();
          const { updateHandoffRule, initHandoffTables } =
            await import("../../utils/handoffDatabase");
          const { logEvent } = await import("../../utils/eventLogsDatabase");
          await initHandoffTables();
          ...
          const body = await c.req.json();
          logger?.info("📝 [HandoffAPI] PUT /api/handoff/rules/:id", {
            id,
            by: sessionUser.email,
          });
          ...
          safeLogger.error("❌ [HandoffAPI] Error updating rule:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const logger = mastra?.getLogger();
          const { createHandoffEvent, initHandoffTables } =
            await import("../../utils/handoffDatabase");
          const { logEvent } = await import("../../utils/eventLogsDatabase");
          await initHandoffTables();
          ...
          const event = await createHandoffEvent({
            ...body,
            triggered_by: sessionUser.email,
          });
          ...
          safeLogger.error("❌ [HandoffAPI] Error creating event:", error);
  ...
  },
  {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const { getAllControlMappings, initHandoffTables } =
            await import("../../utils/handoffDatabase");
          await initHandoffTables();
          ...
          safeLogger.error("❌ [HandoffAPI] Error fetching controls:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const logger = mastra?.getLogger();
          const { updateControlMapping, initHandoffTables } =
            await import("../../utils/handoffDatabase");
          const { logEvent } = await import("../../utils/eventLogsDatabase");
          await initHandoffTables();
          ...
          const id = parseInt(c.req.param("id"));
          const body = await c.req.json();
          logger?.info("📝 [HandoffAPI] PUT /api/handoff/controls/:id", {
            id,
            by: sessionUser.email,
          });
          ...
          safeLogger.error("❌ [HandoffAPI] Error updating control:", error);
