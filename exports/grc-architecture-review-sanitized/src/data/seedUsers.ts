...
export const SEED_USERS: SeedUser[] = [
  ...
  { name: 'Sample User Almassad', team: 'WO Sales', status: 'Active', totalRecords: 225, modules: ['Leads', 'Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User Almutairi', team: 'WO Sales', status: 'Inactive', totalRecords: 229, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'WP Sales', status: 'Inactive', totalRecords: 404, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'BD', status: 'Inactive', totalRecords: 1, modules: ['Deals'] },
  { name: 'Sample User', team: 'MP', status: 'Active', totalRecords: 7, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'WO Sales', status: 'Inactive', totalRecords: 71, modules: ['Deals', 'Contacts', 'Accounts'] },
  ...
  { name: 'Sample User', team: 'WP Sales', status: 'Active', totalRecords: 377, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'MP', status: 'Active', totalRecords: 77, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'WO Sales', status: 'Active', totalRecords: 4, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'WP Sales', status: 'Active', totalRecords: 375, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'WP Sales', status: 'Inactive', totalRecords: 2, modules: ['Contacts', 'Accounts'] },
  ...
  { name: 'Sample User', team: 'Unassigned', status: 'Inactive', totalRecords: 106, modules: ['Deals'] },
  { name: 'Sample User', team: 'MGMT', status: 'Active', totalRecords: 5, modules: ['Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'Unassigned', status: 'Inactive', totalRecords: 46, modules: ['Deals'] },
  { name: 'Sample User', team: 'Unassigned', status: 'Inactive', totalRecords: 2, modules: ['Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'WO Sales', status: 'Active', totalRecords: 790, modules: ['Leads', 'Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'MP', status: 'Inactive', totalRecords: 4, modules: ['Deals', 'Contacts', 'Accounts'] },
  ...
  { name: 'Bashayr  Sample User', team: 'WP Sales', status: 'Active', totalRecords: 844, modules: ['Deals', 'Contacts', 'Accounts'] },
  ...
  { name: 'Sample User', team: 'MP', status: 'Inactive', totalRecords: 90, modules: ['Deals'] },
  { name: 'Sample User', team: 'CS', status: 'Inactive', totalRecords: 1, modules: ['Accounts'] },
  { name: 'Sample User', team: 'WP Sales', status: 'Inactive', totalRecords: 17, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Faisal Alaskar', team: 'Unassigned', status: 'Inactive', totalRecords: 2, modules: ['Contacts', 'Accounts'] },
  { name: 'GOV  ExampleOrg', team: 'WP Sales', status: 'Inactive', totalRecords: 38, modules: ['Deals'] },
  ...
  { name: 'Sample User', team: 'WO Sales', status: 'Inactive', totalRecords: 170, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'WO Sales', status: 'Inactive', totalRecords: 394, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Khalil Aldadah', team: 'MP', status: 'Inactive', totalRecords: 282, modules: ['Deals'] },
  { name: 'Sample User', team: 'WP Sales', status: 'Active', totalRecords: 940, modules: ['Deals', 'Contacts', 'Accounts'] },
  ...
  { name: 'Sample User', team: 'CS', status: 'Active', totalRecords: 1, modules: ['Leads'] },
  { name: 'Sample User', team: 'MP', status: 'Active', totalRecords: 52, modules: ['Deals'] },
  { name: 'Sample User', team: 'WO Sales', status: 'Active', totalRecords: 608, modules: ['Leads', 'Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'WP Sales', status: 'Inactive', totalRecords: 296, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'MP', status: 'Active', totalRecords: 503, modules: ['Leads', 'Deals', 'Contacts', 'Accounts'] },
  { name: 'Sample User', team: 'MRK', status: 'Active', totalRecords: 1, modules: ['Deals'] },
  { name: 'Sample User', team: 'BD', status: 'Inactive', totalRecords: 413, modules: ['Deals'] },
  { name: 'Sample User', team: 'MRK', status: 'Active', totalRecords: 3, modules: ['Leads'] },
  { name: 'Sample User', team: 'MRK', status: 'Inactive', totalRecords: 10, modules: ['Leads'] },
  ...
  { name: 'Sample User', team: 'Unassigned', status: 'Inactive', totalRecords: 15, modules: ['Accounts'] },
  ...
  { name: 'Sample User', team: 'WP Sales', status: 'Inactive', totalRecords: 518, modules: ['Deals', 'Contacts', 'Accounts'] },
  { name: 'Salman  Ali Sample User', team: 'WP Sales', status: 'Inactive', totalRecords: 602, modules: ['Deals', 'Contacts', 'Accounts'] },
  ...
  { name: 'Sample User', team: 'MGMT', status: 'Active', totalRecords: 7, modules: ['Deals', 'Contacts', 'Accounts'] },
  ...
  { name: 'ExampleOrg', team: 'WP Sales', status: 'Inactive', totalRecords: 14, modules: ['Deals', 'Accounts'] },
