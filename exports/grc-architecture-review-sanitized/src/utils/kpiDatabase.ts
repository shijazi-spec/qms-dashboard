...
export async function initKPITables(): Promise<void> {
  ...
  // Name normalization: Sample User name spelled "Sample User" everywhere.
  await pool.query(
    `UPDATE kpi_definitions SET owner_name = 'Sample User' WHERE owner_name = 'Sample User'`,
  );
  ...
  // list and deactivates any older GRQ codes (the previous scorecard, Sample User's
...
async function seedMohammedKPIs(): Promise<void> {
  ...
  // reassigned away from 'governance_officer' after Sample User's resignation
  ...
  logger.info("🌱 [KPIDB] Seeding Sample User...");
  ...
  logger.info("✅ [KPIDB] Seeded Sample User");
}

/**
 * Reassign the six governance-enablement KPIs after Sample User's
...
const MOHAMMED_KPI_REASSIGNMENT: Array<{
  ...
  { code: "MAM-KPI-01", owner_type: "quality_manager", owner_name: "Sample User" },
  { code: "MAM-KPI-02", owner_type: "grc_manager", owner_name: "Sample User" },
  { code: "MAM-KPI-03", owner_type: "grc_manager", owner_name: "Sample User" },
  { code: "MAM-KPI-04", owner_type: "grc_manager", owner_name: "Sample User" },
  { code: "MAM-KPI-05", owner_type: "grc_manager", owner_name: "Sample User" },
  { code: "MAM-KPI-06", owner_type: "grc_manager", owner_name: "Sample User" },
];
 ...
 * format Sample User; the rest follow once she signs off. Idempotent: only
...
const KPI_NAVIGATION_MAPS: Record<string, NavigationStep[]> = {
  ...
  "SALES-KPI-02": [
    ...
    { step: 3, action: "Fix stage hygiene", screen: "Deal Compliance", route: "/duplicates", what_to_check: "Won deals are tagged Signed / Agreement Signed / Paid (not left mid-stage).", if_result: "Won deals mis-staged in CRMProvider", then_action: "Correct the Stage so the win rate reflects reality." },
  ],
...
const GRQ_SCORECARD_KPIS: Array<Partial<KPIDefinition>> = [
  // ===== Quality Manager — Sample User (source: "OKRS with KPIs" sheet) =====
  { kpi_code: "QM-KPI-015", kpi_name: "BU Framework Completion", owner_type: "quality_manager", owner_name: "Sample User", category: "governance", unit: "%", target_value: 100, threshold_green: 95, threshold_amber: 80, threshold_red: 60, threshold_direction: "higher_is_better", is_north_star: true, calc_mode: "checklist", frequency: "quarterly", description: "Business-unit governance frameworks built, pilot-audited and published in QMS.", formula: "(Completed framework packages incl. pilot audit ÷ planned BUs) × 100" },
  { kpi_code: "QM-KPI-002", kpi_name: "BU Audit Execution Rate", owner_type: "quality_manager", owner_name: "Sample User", category: "audit", unit: "%", target_value: 90, threshold_green: 90, threshold_amber: 75, threshold_red: 60, threshold_direction: "higher_is_better", calc_mode: "auto", frequency: "quarterly", description: "Planned audits executed per function within the quarter.", formula: "(Audits completed ÷ planned) × 100" },
  { kpi_code: "QM-KPI-003", kpi_name: "Gap Closure Rate", owner_type: "quality_manager", owner_name: "Sample User", category: "audit", unit: "%", target_value: 90, threshold_green: 85, threshold_amber: 70, threshold_red: 55, threshold_direction: "higher_is_better", calc_mode: "auto", frequency: "monthly", description: "Audit findings / gaps closed within their timeline.", formula: "(Findings closed on-time ÷ total) × 100" },
  { kpi_code: "QM-KPI-009", kpi_name: "Repeat Findings Rate", owner_type: "quality_manager", owner_name: "Sample User", category: "audit", unit: "%", target_value: 10, threshold_green: 10, threshold_amber: 20, threshold_red: 30, threshold_direction: "lower_is_better", calc_mode: "auto", frequency: "quarterly", description: "Findings that recur in a later audit (lower is better).", formula: "(Repeat findings ÷ total findings) × 100" },
  ...
  { kpi_code: "GRC-KPI-003", kpi_name: "Audit Evidence Readiness", owner_type: "grc_manager", owner_name: "Sample User", category: "audit", unit: "%", target_value: 85, threshold_green: 85, threshold_amber: 70, threshold_red: 55, threshold_direction: "higher_is_better", calc_mode: "auto", frequency: "quarterly", description: "Required audit / certification evidence compiled and approved.", formula: "(Evidence ready ÷ required) × 100" },
  { kpi_code: "GRC-KPI-002", kpi_name: "Certification Milestones On-Track", owner_type: "grc_manager", owner_name: "Sample User", category: "compliance", unit: "%", target_value: 100, threshold_green: 100, threshold_amber: 85, threshold_red: 70, threshold_direction: "higher_is_better", is_north_star: true, calc_mode: "auto", frequency: "quarterly", description: "Measures the percentage of planned certification, regulatory, and compliance roadmap milestones achieved within the approved timeline", formula: "Achieved Milestones ÷ Planned Milestones × 100" },
  { kpi_code: "GRC-KPI-008", kpi_name: "Compliance Coverage Index", owner_type: "grc_manager", owner_name: "Sample User", category: "compliance", unit: "%", target_value: 90, threshold_green: 90, threshold_amber: 75, threshold_red: 60, threshold_direction: "higher_is_better", calc_mode: "auto", frequency: "quarterly", description: "Applicable obligations mapped to a control / policy.", formula: "(Mapped obligations ÷ applicable) × 100" },
  { kpi_code: "GRC-KPI-011", kpi_name: "Policy Review Compliance", owner_type: "grc_manager", owner_name: "Sample User", category: "compliance", unit: "%", target_value: 90, threshold_green: 90, threshold_amber: 75, threshold_red: 60, threshold_direction: "higher_is_better", calc_mode: "auto", frequency: "quarterly", description: "Policies reviewed on their scheduled review cycle.", formula: "(Policies reviewed on-cycle ÷ due) × 100" },
  { kpi_code: "GRC-KPI-012", kpi_name: "Regulatory Response Timeliness", owner_type: "grc_manager", owner_name: "Sample User", category: "compliance", unit: "%", target_value: 100, threshold_green: 95, threshold_amber: 85, threshold_red: 70, threshold_direction: "higher_is_better", calc_mode: "manual", frequency: "quarterly", description: "Regulatory requests answered within their deadline.", formula: "(Responses within deadline ÷ total) × 100" },
  { kpi_code: "GRC-KPI-013", kpi_name: "Security Incident Governance Closure Time", owner_type: "grc_manager", owner_name: "Sample User", category: "compliance", unit: "days", target_value: 15, threshold_green: 15, threshold_amber: 30, threshold_red: 45, threshold_direction: "lower_is_better", calc_mode: "manual", frequency: "quarterly", description: "Average days to govern a security incident to closure.", formula: "Avg(closure date − reported date)" },
  { kpi_code: "GRC-KPI-014", kpi_name: "Client/Partner Security Assessment SLA", owner_type: "grc_manager", owner_name: "Sample User", category: "vendor", unit: "%", target_value: 90, threshold_green: 90, threshold_amber: 75, threshold_red: 60, threshold_direction: "higher_is_better", calc_mode: "manual", frequency: "quarterly", description: "Client / partner security assessments answered within SLA.", formula: "(Assessments within SLA ÷ total) × 100" },
  { kpi_code: "GRC-KPI-006", kpi_name: "High-Risk Vendor Findings Closure", owner_type: "grc_manager", owner_name: "Sample User", category: "vendor", unit: "%", target_value: 85, threshold_green: 85, threshold_amber: 70, threshold_red: 55, threshold_direction: "higher_is_better", calc_mode: "auto", frequency: "quarterly", description: "High-risk third-party (vendor) findings remediated / closed.", formula: "(High-risk vendor findings closed ÷ total) × 100" },
];
 ...
 * derived from the platform's own Deal process (CRMProvider Deals → stage-aging SLA, deal
...
async function seedSalesKPIs(): Promise<void> {
  ...
  const salesKPIs: Array<Partial<KPIDefinition>> = [
    { kpi_code: "SALES-KPI-01", kpi_name: "Deal Stage Aging Compliance", owner_type: "sales_team", owner_name: "Sample User", category: "quality", unit: "%", target_value: 90, threshold_green: 90, threshold_amber: 75, threshold_red: 60, threshold_direction: "higher_is_better", frequency: "weekly", description: "Open deals sitting within their stage SLA (Sales SOP stage aging).", formula: "(Deals within stage SLA ÷ open deals) × 100" },
    { kpi_code: "SALES-KPI-02", kpi_name: "Win Rate (Decided Deals)", owner_type: "sales_team", owner_name: "Sample User", category: "quality", unit: "%", target_value: 30, threshold_green: 30, threshold_amber: 20, threshold_red: 12, threshold_direction: "higher_is_better", frequency: "monthly", description: "Of the deals that reached a decision, the share won. Open deals are NOT in the denominator — this is a win rate, not a funnel conversion.", formula: "(Signed + Paid + Closed Won) ÷ (won + Closed Lost) × 100" },
    { kpi_code: "SALES-KPI-03", kpi_name: "Proposal Cycle Time", owner_type: "sales_team", owner_name: "Sample User", category: "quality", unit: "days", target_value: 7, threshold_green: 7, threshold_amber: 14, threshold_red: 21, threshold_direction: "lower_is_better", frequency: "monthly", description: "Average days a deal spends in the Proposal stage.", formula: "Avg(days in Proposal stage)" },
    { kpi_code: "SALES-KPI-04", kpi_name: "Agreement Cycle Time", owner_type: "sales_team", owner_name: "Sample User", category: "quality", unit: "days", target_value: 14, threshold_green: 14, threshold_amber: 30, threshold_red: 45, threshold_direction: "lower_is_better", frequency: "monthly", description: "Average days from Agreement Sent to Agreement Signed.", formula: "Avg(signed date − sent date)" },
    { kpi_code: "SALES-KPI-05", kpi_name: "Deal Document Compliance", owner_type: "sales_team", owner_name: "Sample User", category: "compliance", unit: "%", target_value: 95, threshold_green: 95, threshold_amber: 80, threshold_red: 60, threshold_direction: "higher_is_better", frequency: "monthly", description: "Deals in Proposal/Agreement Signed/Paid carrying the required documents.", formula: "(Deals with required docs ÷ deals in scope) × 100" },
    { kpi_code: "SALES-KPI-06", kpi_name: "CRM Data Accuracy (Deals)", owner_type: "sales_team", owner_name: "Sample User", category: "quality", unit: "%", target_value: 95, threshold_green: 95, threshold_amber: 85, threshold_red: 70, threshold_direction: "higher_is_better", frequency: "monthly", description: "Deals passing the Sales-SOP governance field checks.", formula: "(Clean deals ÷ total deals) × 100" },
    { kpi_code: "SALES-KPI-07", kpi_name: "Follow-Up Effectiveness", owner_type: "sales_team", owner_name: "Sample User", category: "quality", unit: "%", target_value: 80, threshold_green: 80, threshold_amber: 60, threshold_red: 40, threshold_direction: "higher_is_better", frequency: "weekly", description: "Open deals with an upcoming / on-time follow-up task.", formula: "(Deals with on-time follow-up ÷ open deals) × 100" },
    { kpi_code: "SALES-KPI-08", kpi_name: "First-Contact SLA", owner_type: "sales_team", owner_name: "Sample User", category: "quality", unit: "%", target_value: 90, threshold_green: 90, threshold_amber: 75, threshold_red: 60, threshold_direction: "higher_is_better", frequency: "weekly", description: "New deals contacted within the first-contact SLA window.", formula: "(Deals contacted within SLA ÷ new deals) × 100" },
    { kpi_code: "SALES-KPI-09", kpi_name: "Duplicate Rate (Sales)", owner_type: "sales_team", owner_name: "Sample User", category: "quality", unit: "%", target_value: 2, threshold_green: 2, threshold_amber: 5, threshold_red: 10, threshold_direction: "lower_is_better", frequency: "monthly", description: "Deals duplicated in the CRM (same deal logged more than once) — the Sales BU's slice of the Duplicate Radar.", formula: "(Duplicate deals ÷ total deals) × 100" },
  ];
  ...
  // were in fact measuring different things (Sample User 2026-08-17).
  //
...
async function seedCSKPIs(): Promise<void> {
  ...
  const csKPIs: CsSeed[] = [
    ...
    { kpi_code: "CS-KPI-01", kpi_name: "ARR Attainment", category: "quality", frequency: "monthly", calc_mode: "manual", ...pct(100, 90, 80), description: "CS Owner. Validated renewed recurring revenue against the assigned annual ARR target. Source: Client-Hub / CRMProvider Books.", formula: "Validated Renewed ARR ÷ Assigned ARR Target × 100" },
    ...
    { kpi_code: "CS-KPI-03", kpi_name: "QBR Coverage", category: "quality", frequency: "quarterly", calc_mode: "manual", ...pct(90, 75, 60), description: "CS Owner. Quarterly business reviews completed for Gold and Platinum clients. Source: Client-Hub / IdentityProvider Calendar.", formula: "Completed QBRs ÷ QBRs Due × 100" },
    { kpi_code: "CS-KPI-04", kpi_name: "HBR Coverage", category: "quality", frequency: "quarterly", calc_mode: "manual", ...pct(90, 75, 60), description: "CS Owner. Half-yearly business reviews completed for Silver clients. Source: Client-Hub / IdentityProvider Calendar.", formula: "Completed HBRs ÷ HBRs Due × 100" },
    ...
    { kpi_code: "CS-KPI-06", kpi_name: "Renewal Closure Rate", category: "quality", frequency: "monthly", calc_mode: "manual", ...pct(85, 70, 55), description: "CS Owner. Completed renewals against renewals due in the period. Source: Client-Hub / CRMProvider Books / CRMProvider Sign.", formula: "Completed Renewals ÷ Renewals Due × 100" },
