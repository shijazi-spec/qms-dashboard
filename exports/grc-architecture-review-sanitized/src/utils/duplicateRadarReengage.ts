/**
 * LOST-DEAL RE-ENGAGEMENT CHECK (Sample User 2026-09-01).
 *
 ...
 * proposal has NO cool-off (Sample User 2026-09-02), so a lost deal never blocks on
 * its own age.
 *
 ...
 *   • a real Date object            → "Thu Aug 27 2026 <REDACTED_IP> GMT+0300 (…)"
 *   • the sheet's text form         → "2026-08-27 <REDACTED_IP>"
...
/**
 * GOVERNMENT BY NAME (Sample User 2026-09-01 — "I need ZERO errors").
 *
...
export async function runLostDealReengagement(input: {
  ...
  for (let i = 0; i < examined; i++) {
    ...
    // Search BOTH the company name AND the deal name (Sample User 2026-09-01): they
    ...
    if (cs) {
      // Sector + cool-off must agree on the row (Sample User 2026-09-01): when the
    ...
    // NOTE (Sample User 2026-09-02): there is deliberately NO cool-off on the LOST
    ...
    // 6. UNVERIFIABLE (Sample User 2026-09-01 — "ZERO errors"): no domain AND no name
