 ...
 *
 * - SDR-facing documentation and day-to-day process live in **ContactCenterProvider** (team-owned).
 * - **ContactCenterProvider Reporting/Web Services API** for automated pull of call lists + recording URLs is **deferred**;
 ...
 *   live in your internal Quality repository (e.g. IdentityProvider Drive); they are not bundled in this repo.
...
/** ContactCenterProvider API automation (sync from cloud) — not shipped yet; ingest via other paths meanwhile. */
export const SDR_ContactCenterProvider_API_INTEGRATION_STATUS = "deferred" as const;
...
export const SDR_GOVERNANCE_ARTIFACT_NAMES = [
  ...
  "ContactCenterProvider_SDR_QA_Scorecard_COPC_Template.xlsx",
] as const;

export function getSdrProcessScopeForApi(): {
  governance_version: typeof SDR_GOVERNANCE_VERSION;
  ContactCenterProvider_api_integration: typeof SDR_ContactCenterProvider_API_INTEGRATION_STATUS;
  sdr_documentation_home: "ContactCenterProvider";
  ...
  return {
    ...
    ContactCenterProvider_api_integration: SDR_ContactCenterProvider_API_INTEGRATION_STATUS,
    sdr_documentation_home: "ContactCenterProvider",
