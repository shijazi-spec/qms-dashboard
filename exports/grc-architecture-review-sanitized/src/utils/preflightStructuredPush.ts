...
// Sent as an array (multi-select picklist format): ["ExampleOrg"].
export const PREFLIGHT_PRODUCT = process.env.PREFLIGHT_PRODUCT ?? "ExampleOrg";
...
// "<REDACTED_URL>" or "<REDACTED_URL>" would pollute ~half the new records.
const FREE_MAIL_OR_PLACEHOLDER = new Set([
  ...
  "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>",
]);
...
const MULTI_PART_TLDS = ["<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "<REDACTED_HOST>", "co.uk", "com.qa", "com.kw", "com.bh", "com.eg", "com.ae"];

// domainRootToken — the second-level label of a real domain ("arabiandrilling"
// from <REDACTED_HOST>, "kfshrc" from <REDACTED_HOST>). "" when not a real
