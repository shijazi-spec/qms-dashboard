 ...
 * Sales pipeline stage longer than the ExampleOrg Sales SOP allows.
 *
...
// Lifecycle violation (Sample User 2026-07-14).
...
export function evaluateDealStageAging(
  ...
  // deal stuck there for months is still flagged (2026-06-18, Sample User).
