...
const features = { module: "Contacts", layoutSplit: true, mixedDomains: false, domain: "<REDACTED_HOST>" };
assert(signatureMatches({ layoutSplit: true }, features), "single-key subset matches");
assert(signatureMatches({ module: "Contacts", domain: "<REDACTED_HOST>" }, features), "multi-key subset matches");
