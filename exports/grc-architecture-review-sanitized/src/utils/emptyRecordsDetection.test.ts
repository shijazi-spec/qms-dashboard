...
// ExampleOrg exact
assert(isJunkOrTestName("ExampleOrg").test === true, "ExampleOrg exact → test");
assert(isJunkOrTestName("ExampleOrg").test === true, "ExampleOrg (collapsed) → test");
assert(isJunkOrTestName("ExampleOrg Partners").test === false, "ExampleOrg substring → NOT test");
assert(isJunkOrTestName("<REDACTED_HOST> deal").test === false, "ExampleOrg in phrase → NOT test");
