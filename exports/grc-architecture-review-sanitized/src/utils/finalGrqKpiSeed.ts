...
// ★ AUTHORITATIVE from "New_GRQ Final KPIs.xlsx" (Sample User, 2026-06-30): 27 KPIs.
...
export const FINAL_KPIS: FinalKpi[] = [
  // ───────────── Quality — Sample User (6) ─────────────
  { code: "QM-KPI-002", name: "Audit Execution Rate", owner_type: "quality_manager", owner_name: "Sample User", category: "audit", unit: "%", target: 90, weight: 30, direction: "higher_is_better", frequency: "quarterly", calc_mode: "auto", north_star: true, description: "Measures the percentage of planned internal audits completed within the defined period across in-scope business units", formula: "Completed Audits ÷ Planned Audits × 100", data_source: "QMS Platform" },
  { code: "QM-KPI-015", name: "BU Framework Readiness Rate", owner_type: "quality_manager", owner_name: "Sample User", category: "governance", unit: "%", target: 100, weight: 30, direction: "higher_is_better", frequency: "quarterly", calc_mode: "checklist", north_star: true, description: "Measures the percentage of planned business units that completed all pre-pilot framework preparation steps and achieved Ready-for-Pilot status", formula: "Number of planned BUs reaching “Ready for Pilot” status ÷ total planned BUs × 100", data_source: "QMS Platform" },
  { code: "QM-KPI-008", name: "BU Pilot Validation Completion Rate", owner_type: "quality_manager", owner_name: "Sample User", category: "governance", unit: "%", target: 100, weight: 20, direction: "higher_is_better", frequency: "quarterly", calc_mode: "checklist", north_star: true, description: "Measures the percentage of planned pilot-ready business units that completed pilot validation, including pilot execution, reporting, and action planning", formula: "Planned Pilot-Ready BUs Completing Pilot Validation ÷ Total Quarterly Pilot-Planned BUs × 100", data_source: "QMS Platform" },
  { code: "QM-KPI-009", name: "Repeat Findings Rate", owner_type: "quality_manager", owner_name: "Sample User", category: "audit", unit: "%", target: 10, weight: 5, direction: "lower_is_better", frequency: "quarterly", calc_mode: "manual", description: "Measures the percentage of audit findings (2 times consecutively) that recur from previously identified issues within the defined review period", formula: "Repeat Findings (persisting NCs) ÷ Total Findings × 100", data_source: "Audit Report Dashboard" },
  ...
  { code: "GRC-KPI-002", name: "Certification Milestones On Track", owner_type: "grc_manager", owner_name: "Sample User", category: "compliance", unit: "%", target: 100, weight: 15, direction: "higher_is_better", frequency: "quarterly", calc_mode: "auto", north_star: true, description: "Measures the percentage of planned certification, regulatory, and compliance roadmap milestones achieved within the approved timeline", formula: "Achieved Milestones ÷ Planned Milestones × 100", data_source: "Certification Milestone Plan (GRQ-PLAN-2026-01)" },
  { code: "GRC-KPI-012", name: "Regulatory Response Timeliness", owner_type: "grc_manager", owner_name: "Sample User", category: "compliance", unit: "%", target: 90, weight: 10, direction: "higher_is_better", frequency: "monthly", calc_mode: "manual", description: "Measures the percentage of regulatory responses submitted within the defined SLA", formula: "Responses Within SLA ÷ Total Regulatory Responses × 100", data_source: "Compliance Log" },
  { code: "GRC-KPI-013", name: "Security Incident On-Time Closure Rate", owner_type: "grc_manager", owner_name: "Sample User", category: "compliance", unit: "%", target: 95, weight: 10, direction: "higher_is_better", frequency: "monthly", calc_mode: "manual", description: "Measures the percentage of security incidents within GRC scope that are closed within the approved target timeline", formula: "Security Incidents Closed Within Target ÷ Total Security Incidents Due for Closure × 100", data_source: "Incident Register" },
