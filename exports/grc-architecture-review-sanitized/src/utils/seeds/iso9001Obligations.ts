...
export const ISO9001_OBLIGATION_DEFINITIONS: ObligationDef[] = [
  ...
  ...build("7. Support", 400, [
    ...
    ["<REDACTED_IP>", "Monitoring and measuring resources — General", "Provide resources to ensure valid and reliable monitoring/measuring results."],
    ["<REDACTED_IP>", "Measurement traceability", "Where measurement traceability is required, calibrate or verify measurement equipment at specified intervals.", "detective", "quarterly", "high"],
