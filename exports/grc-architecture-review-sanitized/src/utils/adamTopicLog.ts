...
export const PLATFORM_SECTIONS: SectionDef[] = [
  { key: "<REDACTED_SECRET>", label: "Data cleanup — duplicates merged, what's still open", href: "/duplicates",
    keywords: ["duplicate", "duplicates", "cleanup", "clean up", "merge", "merged", "dedupe", "تكرار"] },
  { key: "<REDACTED_SECRET>", label: "CS Lifecycle — phases, renewals, violations", href: "/duplicates",
    keywords: ["cs lifecycle", "lifecycle", "renewal", "renewals", "churn", "onboarding", "adoption", "customer success"] },
  { key: "<REDACTED_SECRET>", label: "Deals — stage aging and document compliance", href: "/duplicates",
    keywords: ["deal compliance", "deal docs", "required documents", "agreement", "proposal", "stage aging", "deal", "deals"] },
  { key: "<REDACTED_SECRET>", label: "KPIs — the GRQ scorecard and any red KPIs", href: "/kpis",
    keywords: ["kpi", "kpis", "scorecard", "target", "red kpi"] },
  { key: "<REDACTED_SECRET>", label: "Open actions — CAPAs and owner accountability", href: "/qms",
    keywords: ["capa", "capas", "corrective", "corrective action", "open action", "open actions", "owner accountability", "accountability"] },
  { key: "<REDACTED_SECRET>", label: "Preflight — vetting a company before creating it", href: "/duplicates",
    keywords: ["preflight", "existing client", "already a client", "already client", "vet", "cold contact"] },
  { key: "<REDACTED_SECRET>", label: "Quality Reports — per-business-unit reporting", href: "/quality-reports",
    keywords: ["quality report", "quality reports", "business unit", "bu report", "per bu"] },
  { key: "<REDACTED_SECRET>", label: "Internal Audits — audit programme and findings", href: "/audits",
    keywords: ["audit", "audits", "internal audit", "finding", "findings", "nonconformity", "nonconformance"] },
  { key: "<REDACTED_SECRET>", label: "Compliance — obligations and audit readiness", href: "/compliance",
    keywords: ["compliance", "obligation", "obligations", "pdpl", "iso", "regulation", "regulatory"] },
  { key: "<REDACTED_SECRET>", label: "Risk Management — the risk register", href: "/risks",
    keywords: ["risk", "risks", "risk register", "mitigation"] },
  { key: "<REDACTED_SECRET>", label: "Documents — SOPs, policies and document control", href: "/integrated-qms",
    keywords: ["sop", "sops", "policy", "policies", "document control", "governance document", "procedure"] },
  { key: "<REDACTED_SECRET>", label: "Call Evaluation — call quality scoring", href: "/calls",
    keywords: ["call", "calls", "call evaluation", "call quality", "recording"] },
  { key: "<REDACTED_SECRET>", label: "Handoff Tracker — Quality and GRC handoffs", href: "/handoff-tracker",
    keywords: ["handoff", "handoffs", "hand off"] },
  { key: "<REDACTED_SECRET>", label: "Vendors — vendor assessments", href: "/vendors",
    keywords: ["vendor", "vendors", "supplier", "suppliers"] },
  { key: "<REDACTED_SECRET>", label: "Management Review", href: "/reviews",
    keywords: ["management review", "mgmt review", "review meeting"] },
  { key: "<REDACTED_SECRET>", label: "Fraud — rules, incidents and KPIs", href: "/fraud-incidents",
    keywords: ["fraud", "incident", "incidents", "country risk"] },
  { key: "<REDACTED_SECRET>", label: "Team Performance", href: "/team",
    keywords: ["team performance", "team"] },
  { key: "<REDACTED_SECRET>", label: "AI Approvals Queue — actions waiting for sign-off", href: "/ai-approvals",
