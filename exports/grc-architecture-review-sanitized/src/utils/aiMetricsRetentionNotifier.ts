...
function buildEmailHtml(
  ...
  return [
    ...
    `<p style="color:#888;font-size:12px;">ExampleOrg AI metrics retention | dashboard override saved</p>`,
  ].join("");
}
...
function buildPruneNowEmailHtml(
  ...
  return [
    ...
    noteHtml,
    `<p><a href="${link}">Open the AI Operations panel</a></p>`,
    `<p style="color:#888;font-size:12px;">ExampleOrg AI metrics retention | manual prune executed</p>`,
  ].join("");
}
