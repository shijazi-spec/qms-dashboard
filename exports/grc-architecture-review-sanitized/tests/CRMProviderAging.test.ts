/**
 * Unit tests for src/utils/CRMProviderAging.ts (Task #825).
 *
 ...
 *
 * Run:  npx tsx tests/CRMProviderAging.test.ts
 */
...
// ─── End-to-end with stub CRMProvider fetchers ──────────────────────────────────────
