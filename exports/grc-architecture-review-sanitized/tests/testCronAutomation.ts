 ...
 * - Visit <REDACTED_URL> to see execution in Inngest dashboard
 */
...
async function testCronTrigger() {
  ...
  try {
    ...
    console.log(`\n📊 Check execution at: <REDACTED_URL>`);
    ...
    console.error(
      "  2. Is Inngest dev server running? (inngest dev -u <REDACTED_URL> --port 3000)",
    );
    console.error(
