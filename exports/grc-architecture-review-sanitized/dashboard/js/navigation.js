...
const ExampleOrgNav = {
  ...
  _navItemLabel(id) {
    switch (id) {
      ...
      case 'ai-approvals':    return this._t('<REDACTED_HOST>-approvals');
  ...
  navigationGroups: [
    {
      id: 'quality',
      label: 'Quality',
      icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 <REDACTED_PHONE> 0z"/></svg>`,
      color: 'blue',
      items: [
    ...
    // Document Control — promoted to its own top-level group per Sample User's
    ...
    // audits + risk/oversight.
    {
      ...
      // Purple so it stands out from the blue Quality section above it
      // (Sample User 2026-07-29). Was 'indigo', which isn't in getColorClasses and
      // silently fell back to blue — identical to Quality.
      color: 'purple',
      items: [
    ...
    },
    {
      id: 'grc',
      label: 'GRC',
      icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.<REDACTED_PHONE>.944a11.<REDACTED_PHONE> 3.04A12.<REDACTED_PHONE> 9c0 <REDACTED_PHONE>.<REDACTED_PHONE> <REDACTED_PHONE>.052-.382-3.016z"/></svg>`,
      color: 'teal',
      items: [
        ...
        // Moved to the Tools group (Sample User 2026-09-02) — both are operator
    ...
    },
    {
      ...
      id: 'fraud',
      label: 'Fraud Module',
      icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.<REDACTED_PHONE>-3L13.732 4c-.<REDACTED_PHONE>.464 0L3.34 16c-.<REDACTED_PHONE> 3z"/></svg>`,
      color: 'red',
      items: [
    ...
    },
    {
      id: 'value',
      label: 'Value',
      icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-<REDACTED_PHONE> 2s1.<REDACTED_PHONE>.343 2-3 2m0-8c1.<REDACTED_PHONE> 1M12 8V7m0 1v8m0 0v1m0-1c-<REDACTED_PHONE>-1M21 12a9 <REDACTED_PHONE> 0z"/></svg>`,
      color: 'green',
      items: [
    ...
    },
    {
      ...
      id: 'tools',
      label: 'Tools',
      icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.<REDACTED_PHONE>.415 3.414H4.828c-<REDACTED_PHONE>.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/></svg>`,
      color: 'teal',
      items: [
    ...
    },
    {
      ...
      icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.<REDACTED_PHONE> 3.35 0a1.<REDACTED_PHONE>.066c1.<REDACTED_PHONE>.37a1.<REDACTED_PHONE>.572c1.<REDACTED_PHONE> 3.35a1.<REDACTED_PHONE>.573c.<REDACTED_PHONE> 2.37a1.<REDACTED_PHONE>.065c-.<REDACTED_PHONE>-3.35 0a1.<REDACTED_PHONE>.066c-<REDACTED_PHONE>-2.37a1.<REDACTED_PHONE>.572c-<REDACTED_PHONE> 0-3.35a1.<REDACTED_PHONE>.573c-.<REDACTED_PHONE><REDACTED_IP> <REDACTED_PHONE>.065zM15 12a3 <REDACTED_PHONE> 0z"/></svg>`,
      color: 'slate',
    ...
    },
    {
      id: 'support',
      label: 'Support',
      icon: `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.<REDACTED_PHONE>-<REDACTED_PHONE>-<REDACTED_PHONE>.<REDACTED_PHONE>.994 1.093m0 3h.01M21 12a9 <REDACTED_PHONE> 0z"/></svg>`,
      color: 'purple',
      items: [
  ...
  getItemIcon(iconName) {
    const icons = {
      ...
      'shield-check': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m5.618-4.016A11.<REDACTED_PHONE>.944a11.<REDACTED_PHONE> 3.04A12.<REDACTED_PHONE> 9c0 <REDACTED_PHONE>.<REDACTED_PHONE> <REDACTED_PHONE>.052-.382-3.016z"/></svg>`,
      ...
      'phone': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.<REDACTED_PHONE> 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.<REDACTED_PHONE> 6V5z"/></svg>`,
      'beaker': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19.428 15.428a2 2 0 00-1.022-.547l-2.387-.477a6 6 0 00-3.86.517l-.318.158a6 6 0 01-3.86.517L6.05 15.21a2 2 0 00-1.806.547M8 4h8l-1 1v5.172a2 2 0 00.586 1.414l5 5c1.<REDACTED_PHONE>.415 3.414H4.828c-<REDACTED_PHONE>.414-3.414l5-5A2 2 0 009 10.172V5L8 4z"/></svg>`,
      'exclamation-triangle': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.<REDACTED_PHONE>-3L13.732 4c-.<REDACTED_PHONE>.464 0L3.34 16c-.<REDACTED_PHONE> 3z"/></svg>`,
      ...
      'check-circle': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 <REDACTED_PHONE> 0z"/></svg>`,
      'users': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 <REDACTED_PHONE> 0z"/></svg>`,
      'database': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 7v10c0 <REDACTED_PHONE> 4s8-1.79 8-4V7M4 7c0 <REDACTED_PHONE> 4s8-1.79 8-4M4 7c0-<REDACTED_PHONE>-4s8 1.79 8 4m0 5c0 <REDACTED_PHONE> 4s-8-1.79-8-4"/></svg>`,
      ...
      'currency-dollar': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-<REDACTED_PHONE> 2s1.<REDACTED_PHONE>.343 2-3 2m0-8c1.<REDACTED_PHONE> 1M12 8V7m0 1v8m0 0v1m0-1c-<REDACTED_PHONE>-1M21 12a9 <REDACTED_PHONE> 0z"/></svg>`,
      'user-group': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17 20h5v-2a3 <REDACTED_PHONE>.857M17 20H7m10 0v-2c0-.<REDACTED_PHONE>.857M7 20H2v-2a3 <REDACTED_PHONE>.857M7 20v-2c0-.<REDACTED_PHONE>.857m0 0a5.<REDACTED_PHONE> 0M15 7a3 <REDACTED_PHONE> 0zm6 3a2 <REDACTED_PHONE> 0zM7 10a2 <REDACTED_PHONE> 0z"/></svg>`,
      ...
      'book-open': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 6.253v13m0-13C10.<REDACTED_PHONE> 5S4.<REDACTED_PHONE>.253v13C4.<REDACTED_PHONE>.5 18s3.<REDACTED_PHONE>.253m0-13C13.<REDACTED_PHONE>.5 5c1.<REDACTED_PHONE>.253v13C19.<REDACTED_PHONE> 16.5 18c-<REDACTED_PHONE>.253"/></svg>`,
      'question-mark-circle': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8.228 9c.<REDACTED_PHONE>-<REDACTED_PHONE>-<REDACTED_PHONE>.<REDACTED_PHONE>.994 1.093m0 3h.01M21 12a9 <REDACTED_PHONE> 0z"/></svg>`,
      'cog': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10.325 4.317c.<REDACTED_PHONE> 3.35 0a1.<REDACTED_PHONE>.066c1.<REDACTED_PHONE>.37a1.<REDACTED_PHONE>.572c1.<REDACTED_PHONE> 3.35a1.<REDACTED_PHONE>.573c.<REDACTED_PHONE> 2.37a1.<REDACTED_PHONE>.065c-.<REDACTED_PHONE>-3.35 0a1.<REDACTED_PHONE>.066c-<REDACTED_PHONE>-2.37a1.<REDACTED_PHONE>.572c-<REDACTED_PHONE> 0-3.35a1.<REDACTED_PHONE>.573c-.<REDACTED_PHONE><REDACTED_IP> <REDACTED_PHONE>.065z"/><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 <REDACTED_PHONE> 0z"/></svg>`,
      'document': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 <REDACTED_PHONE> 3H7a2 2 0 00-2 2v14a2 2 0 002 2z"/></svg>`,
      'brain': `<svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9.663 17h4.673M12 3v1m6.364 1.636l-.707.707M21 12h-1M4 12H3m3.343-5.657l-.707-.707m2.828 9.9a5 5 0 117.072 0l-.548.547A3.<REDACTED_PHONE>.469V19a2 2 0 11-4 0v-.531c0-.<REDACTED_PHONE>.386l-.548-.547z"/></svg>`
    };
  ...
  _ensureTableSortLoaded() {
    ...
    s.async = true;
    s.setAttribute('data-ExampleOrg-table-sort', '1');
  ...
  openAssistant() {
    ...
    var existing = document.querySelector('script[data-ExampleOrg-consultant-widget]');
  ...
  refreshDashboard() {
    ...
    if (btn) {
      ...
      btn.innerHTML = '<svg class="w-4 h-4 animate-spin" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4v5h.582m15.356 2A8.<REDACTED_PHONE> 9m0 0H9m11 11v-5h-.581m0 0a8.<REDACTED_PHONE>-2m15.357 2H15"/></svg><span>Refreshing…</span>';
    }
  ...
  render() {
    const navContainer = document.getElementById('ExampleOrg-nav');
    if (!navContainer) {
      console.error('ExampleOrg Nav: Container #ExampleOrg-nav not found');
      return;
    }
    ...
    if (localStorage.getItem('ExampleOrg-nav-collapsed') === '1') {
    ...
    navContainer.innerHTML = `
      <div class="wp-topstrip bg-white border-b border-gray-200 shadow-sm flex items-center justify-between px-3">
        <div class="flex items-center space-x-2">
          <button id="wp-rail-toggle" class="wp-rail-toggle-btn p-2 rounded-lg text-gray-600 hover:bg-gray-100 items-center" aria-label="Toggle navigation menu" aria-controls="ExampleOrg-nav" aria-expanded="true" data-testid="button-rail-toggle">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/></svg>
          </button>
          <button id="mobile-menu-btn" class="wp-mobile-menu-btn p-2 rounded-lg text-gray-600 hover:bg-gray-100 items-center" aria-label="Open navigation menu" aria-controls="ExampleOrg-nav" aria-expanded="false" data-testid="button-mobile-menu">
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"/></svg>
          </button>
        ...
        <div class="flex items-center space-x-2">
          ...
          <div class="relative nav-dropdown" data-group="notifications">
            <button class="relative p-1.5 rounded-lg hover:bg-gray-100 transition" aria-label="${this._t('nav.notifications')}" aria-haspopup="true" aria-expanded="false" aria-controls="nav-notifications-list" data-testid="button-notifications">
              <svg class="w-5 h-5 text-gray-500" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 17h5l-1.405-1.405A2.<REDACTED_PHONE>.158V11a6.<REDACTED_PHONE>.659V5a2 2 0 10-4 0v.341C7.<REDACTED_PHONE> 11v3.159c0 .<REDACTED_PHONE>.436L4 17h5m6 0v1a3 3 0 11-6 0v-1m6 0H9"/></svg>
      ...
      <aside id="nav-rail" class="wp-rail bg-white border-r border-gray-200 flex flex-col" aria-label="Primary navigation" data-testid="nav-rail">
        <div class="wp-search-wrap p-3 border-b border-gray-100">
          <div class="relative">
            <svg class="w-4 h-4 text-gray-400 absolute left-2.5 top-1/2 -translate-y-1/2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 21l-4.35-4.35M11 19a8 <REDACTED_PHONE> 16z"/></svg>
      ...
      <div class="wp-rail-group wp-rail-group-meta px-2 mb-1" data-group="recent" data-open="${open ? 'true' : 'false'}">
        <button type="button" class="wp-group-toggle w-full flex items-center px-2 py-2 rounded-lg hover:bg-gray-50 transition relative" aria-expanded="${open ? 'true' : 'false'}" aria-describedby="tooltip-group-recent" data-testid="button-group-recent">
          <span class="text-gray-500 me-2 flex-shrink-0" aria-hidden="true">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 <REDACTED_PHONE> 0z"/></svg>
          </span>
          <span class="wp-label flex-1 text-start text-xs font-semibold uppercase tracking-wide text-gray-500">${this.escapeHtml(label)}</span>
          <svg class="wp-label wp-group-chevron w-3 h-3 text-gray-400 flex-shrink-0" aria-hidden="true" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"/></svg>
  ...
  bindEvents() {
    ...
    if (railToggle) {
      ...
      railToggle.addEventListener('click', () => {
        ...
        try { localStorage.setItem('ExampleOrg-nav-collapsed', collapsed ? '1' : '0'); } catch(_) {}
      });
    }
