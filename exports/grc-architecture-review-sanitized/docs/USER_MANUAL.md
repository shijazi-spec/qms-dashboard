# ExampleOrg Enterprise GRC & Quality Management Platform - User Manual
...
### What is ExampleOrg GRC & Quality Platform?

ExampleOrg Enterprise GRC & Quality Management Platform is a comprehensive, AI-powered system combining governance, risk, and compliance (GRC) with quality management. The platform provides:
...
| ExampleOrg | `/qms` | CAPA, nonconformance, and training |
...
- **ExampleOrg Logo** - Click to return to the Quality Dashboard
...
- Public domains (<REDACTED_HOST>, <REDACTED_HOST>, etc.) are excluded

#### Quick Add Duplicates
Pre-configured test sets to quickly populate duplicate scenarios:
- **3 Leads @ <REDACTED_HOST>** - Three leads with same domain, different name spellings
- **2 Leads + 1 Deal @ <REDACTED_HOST>** - Mixed record types in one cluster
- **2 Deals @ <REDACTED_HOST>** - Two deals for same company
...
- Duplicates are grouped by email domain (e.g., all records with @<REDACTED_HOST> are clustered together)
- Public domains like <REDACTED_HOST>, <REDACTED_HOST>, <REDACTED_HOST> are excluded
...
The User Onboarding module helps new users learn the ExampleOrg system through interactive guides, videos, and contextual help.
...
*This manual covers ExampleOrg Agentic AI Quality Specialist v1.0*
