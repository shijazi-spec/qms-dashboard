...
const getWeather = async (location: string) => {
  // Geocoding API call
  const geocodingUrl = `<REDACTED_URL>`;
...
NOTE: ai-sdk v5 is still in beta, while it is in beta you'll have to install the beta ai-sdk versions and the beta mastra versions. See [here](<REDACTED_URL> for more information
...
```json showLineNumbers copy filename="package.json"
{
  "dependencies": {
    ...
    "@mastra/memory": "0.0.0-ai-v5-<REDACTED_PHONE>",
    "next": "15.1.7",
    "react": "^19.0.0",
    "react-dom": "^19.0.0",
    "swr": "^2.3.3",
...
3. Visit `<REDACTED_URL>` and ask about weather in different cities!
