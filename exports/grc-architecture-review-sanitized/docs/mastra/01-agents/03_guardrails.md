...
const result = await agent.generate("Is this credit card number valid?: <REDACTED_PHONE> 4332");
...
const stream = await agent.stream("Is this credit card number valid?: <REDACTED_PHONE> 4332");
