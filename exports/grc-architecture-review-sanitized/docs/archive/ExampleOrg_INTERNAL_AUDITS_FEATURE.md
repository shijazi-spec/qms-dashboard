...
> **One end-to-end audit lifecycle at ExampleOrg** — covering the Annual Audit Programme (HITL sign-off), Internal Audits Dashboard, AI Quality Audits, Manual Audit Intake (off-platform reports), and External Audits (certification/regulatory/customer), all wired into a single finding traceability spine.
