...
const PAGES = {
  ...
  'kpis.html': [
    ...
    opt('quality_manager', 'Sample User (Quality Manager)', 'kpis.o_quality_manager'),
    opt('grc_manager', 'Sample User (GRC Manager)', 'kpis.o_grc_manager'),
  ...
  'calls.html': [
    ...
    { from: '<h3 class="text-lg font-semibold text-white">ContactCenterProvider Integration</h3>', to: '<h3 class="text-lg font-semibold text-white" data-i18n="calls.sec_ContactCenterProvider">ContactCenterProvider Integration</h3>' },
    ...
    lbl('ContactCenterProvider Domain', 'calls.f_ContactCenterProvider_domain'),
  ...
  'feedback.html': [
    ...
    { from: '<p class="text-gray-600 mt-2">View and analyze feedback from Sample User, Sample User, and your team members across all dashboards</p>', to: '<p class="text-gray-600 mt-2" data-i18n="feedback.subtitle">View and analyze feedback from Sample User, Sample User, and your team members across all dashboards</p>' },
  ...
  'infographic.html': [
    ...
    { from: '<h3 class="text-lg font-bold text-slate-900">Send to ChatProvider</h3>', to: '<h3 class="text-lg font-bold text-slate-900" data-i18n="infographic.h3_ChatProvider">Send to ChatProvider</h3>' },
