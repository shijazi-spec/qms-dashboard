...
const PAGES = {
  ...
  'feedback.html': [
    ...
    { from: '<p class="text-gray-600 mt-2">View and analyze feedback from Sara, Sample User, and your team members across all dashboards</p>', to: '<p class="text-gray-600 mt-2" data-i18n="feedback.subtitle">View and analyze feedback from Sara, Sample User, and your team members across all dashboards</p>' },
