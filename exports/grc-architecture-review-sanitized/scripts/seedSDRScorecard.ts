...
const sdrScorecardData = {
  name: 'ExampleOrg SDR Quality Scorecard v1.0',
  description: 'Comprehensive SDR call quality evaluation based on COPC principles and ExampleOrg governance standards. Evaluates People, Process, and Governance dimensions.',
  crm_module: 'Leads',
  team_name: 'SDR',
  version: '1.0',
  is_active: true,
...
async function seedSDRScorecard() {
  console.log('🌱 Creating ExampleOrg SDR Quality Scorecard...');
