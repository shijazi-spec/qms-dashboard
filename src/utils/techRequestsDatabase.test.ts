...
const fakeRow = {
  id: 1, product: "Demo", client_name: "ACME", contact_email: "contact@acme.com",
  request_text: "Set up demo env", assignee_name: "Engineer",
  assignee_email: "eng@example.com", due_date: null, status: "sent",
  response_note: null, responded_at: null, follow_up_at: null,
  last_reminder_at: null, action_token: "a".repeat(64), created_by: "admin",
...

{
  ...
  if (params) {
    ...
    assert(
      params.some(p => String(p) === "devops@example.com"),
