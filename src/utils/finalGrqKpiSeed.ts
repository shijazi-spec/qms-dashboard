...
const FINAL_KPIS: FinalKpi[] = [
  ...
  { code: "GRC-KPI-020", name: "Overdue Risk Reviews", owner_type: "grc_manager", owner_name: "Maram AlHarbi", category: "risk", unit: "%", target: 10, direction: "lower_is_better", frequency: "monthly", calc_mode: "auto", description: "Measures the percentage of live risks in the register whose scheduled review date has passed. Keeps the internal risk register current.", formula: "Live Risks Past Next Review Date ÷ Total Live Risks × 100", data_source: "Risk Register" },
  { code: "GRC-KPI-021", name: "Overdue Vendor Reassessments", owner_type: "grc_manager", owner_name: "Maram AlHarbi", category: "vendor", unit: "%", target: 10, direction: "lower_is_better", frequency: "monthly", calc_mode: "auto", description: "Measures the percentage of active vendors whose scheduled re-assessment date has passed. Keeps third-party risk coverage current.", formula: "Active Vendors Past Next Assessment Date ÷ Total Active Vendors × 100", data_source: "Vendor Risk Tracker" },
