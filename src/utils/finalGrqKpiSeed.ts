...
const FINAL_KPIS: FinalKpi[] = [
  ...
  { code: "GRQ-KPI-02", name: "Quality ↔ GRC Handoff Effectiveness", owner_type: "shared", owner_name: "GRQ Team", category: "governance", unit: "%", target: 95, weight: 2.5, direction: "higher_is_better", frequency: "monthly", calc_mode: "manual", description: "Measures the percentage of handoffs between Quality and GRC that are submitted on time, correctly logged, accepted, and transferred into the required workflow without rework or delay", formula: "Successful Handoffs ÷ Total Handoffs × 100", data_source: "Handoff Emails" },
];
