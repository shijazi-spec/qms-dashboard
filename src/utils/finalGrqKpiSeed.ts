...
const FINAL_KPIS: FinalKpi[] = [
  ...
  { code: "QM-KPI-009", name: "Repeat Findings Rate", owner_type: "quality_manager", owner_name: "Sarah Hijazi", category: "audit", unit: "%", target: 10, direction: "lower_is_better", frequency: "quarterly", calc_mode: "auto", description: "Recurring findings from previous audits.", formula: "Repeat Findings ÷ Total Findings × 100", data_source: "Audit Findings Log on QMS Platform" },
