...
export const FINAL_KPIS: FinalKpi[] = [
  ...
  { code: "QM-KPI-008", name: "BU Coverage Rate", owner_type: "quality_manager", owner_name: "Sarah Hijazi", category: "governance", unit: "%", target: 100, weight: 20, direction: "higher_is_better", frequency: "quarterly", calc_mode: "bu_coverage", north_star: true, description: "Measures governance coverage across the business units in the Quality Plan 2026 BU Coverage Plan, giving each BU partial credit for how far through its governance checklist it is", formula: "Average governance-checklist completion % across the planned BUs (a BU 35% complete counts 0.35 of a covered BU)", data_source: "QMS Platform" },
