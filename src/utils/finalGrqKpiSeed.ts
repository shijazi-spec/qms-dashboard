...
const FINAL_KPIS: FinalKpi[] = [
  ...
  { code: "SPEC-KPI-01", name: "Governance Operations Readiness Index", owner_type: "grq_specialist", owner_name: "AlHanouf", category: "governance", unit: "%", target: 95, direction: "higher_is_better", frequency: "quarterly", calc_mode: "manual", north_star: true, description: "Overall readiness of the governance support functions (docs, compliance, evidence, reporting, CAPA) - a roll-up of this team's KPIs.", formula: "Equal-weighted average of supporting KPIs #2–#7 (each 1/6)", data_source: "KPI Dashboard (roll-up)" },
  ...
  { code: "LEG-KPI-01", name: "Legal Governance Score", owner_type: "legal_specialist", owner_name: "Ali Fahad", category: "compliance", unit: "%", target: 95, direction: "higher_is_better", frequency: "quarterly", calc_mode: "manual", north_star: true, description: "Overall legal effectiveness and compliance - a roll-up of the legal KPIs.", formula: "Equal-weighted average of Legal KPIs #2–#10 (each 1/9)", data_source: "KPI Dashboard (roll-up)" },
  ...
  { code: "GRQ-KPI-01", name: "GRQ Health Score", owner_type: "shared", owner_name: "GRQ Team", category: "governance", unit: "%", target: 90, direction: "higher_is_better", frequency: "quarterly", calc_mode: "manual", north_star: true, description: "Overall operational health of the GRQ functions - a weighted roll-up of Quality, GRC, Specialist and Legal achievement.", formula: "Quality×35% + GRC×35% + GRQ Specialist×15% + Legal×15%", data_source: "KPI Dashboard (roll-up)" },
  ...
  { code: "GRQ-KPI-04", name: "Executive GRQ Score", owner_type: "shared", owner_name: "GRQ Team", category: "governance", unit: "%", target: 90, direction: "higher_is_better", frequency: "quarterly", calc_mode: "manual", description: "Top-line GRQ performance - an equal blend of Quality health and GRC achievement.", formula: "50% × Quality Health Score + 50% × GRC KPI average", data_source: "KPI Dashboard (roll-up)" },
];
