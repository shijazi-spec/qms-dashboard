...
const FINAL_KPIS: FinalKpi[] = [
  ...
  { code: "QM-KPI-015", name: "BU Framework Readiness Rate", owner_type: "quality_manager", owner_name: "Sarah Hijazi", category: "governance", unit: "%", target: 100, weight: 30, direction: "higher_is_better", frequency: "quarterly", calc_mode: "checklist", north_star: true, description: "Measures the percentage of planned business units that completed all pre-pilot framework preparation steps and achieved Ready-for-Pilot status.", formula: "BUs reaching 'Ready for Pilot' status ÷ total planned BUs × 100", data_source: "QMS Platform — per-BU Readiness action plan (7 stages)" },
  ...
  { code: "QM-KPI-009", name: "Repeat Findings Rate", owner_type: "quality_manager", owner_name: "Sarah Hijazi", category: "audit", unit: "%", target: 10, weight: 5, direction: "lower_is_better", frequency: "quarterly", calc_mode: "manual", description: "Measures the percentage of audit findings that recur from previously identified issues within the defined review period.", formula: "Repeat Findings ÷ Total Findings × 100", data_source: "Audit Report Dashboard" },
  { code: "QM-KPI-012", name: "CAPA Effectiveness Rate", owner_type: "quality_manager", owner_name: "Sarah Hijazi", category: "quality", unit: "%", target: 90, weight: 5, direction: "higher_is_better", frequency: "quarterly", calc_mode: "manual", description: "Measures the percentage of reviewed CAPAs verified effective in preventing recurrence within the effectiveness review period.", formula: "Effective CAPAs ÷ CAPAs reviewed for effectiveness × 100", data_source: "CAPA Register" },
  ...
  { code: "GRC-KPI-013", name: "Security Incident On-Time Closure Rate", owner_type: "grc_manager", owner_name: "Maram AlHarbi", category: "compliance", unit: "%", target: 95, weight: 10, direction: "higher_is_better", frequency: "monthly", calc_mode: "manual", description: "Measures the percentage of GRC-scope security incidents closed within the approved target timeline.", formula: "Security Incidents Closed Within Target ÷ Total Due for Closure × 100", data_source: "Incident Register" },
  ...
  { code: "GRC-KPI-014", name: "Third-Party Assessment SLA", owner_type: "grc_manager", owner_name: "Maram AlHarbi", category: "vendor", unit: "%", target: 90, weight: 10, direction: "higher_is_better", frequency: "quarterly", calc_mode: "manual", description: "Measures the percentage of in-scope third-party, client, and partner security/risk assessments completed within the defined SLA.", formula: "Assessments Completed Within SLA ÷ Total In-Scope Requests × 100", data_source: "Third-Party Assessment Log" },
  ...
  { code: "LEG-KPI-02", name: "Contract Review SLA", owner_type: "legal_specialist", owner_name: "Ali Fahad", category: "compliance", unit: "%", target: 95, weight: 25, direction: "higher_is_better", frequency: "monthly", calc_mode: "manual", description: "Measures the percentage of in-scope contracts reviewed within the defined SLA, controlling overdue review backlog.", formula: "Contracts Reviewed Within SLA ÷ Total Contracts Due for Review × 100", data_source: "Contract Register" },
  ...
  { code: "GRQ-KPI-02", name: "Quality ↔ GRC Handoff Effectiveness", owner_type: "shared", owner_name: "GRQ Team", category: "governance", unit: "%", target: 95, weight: 2.5, direction: "higher_is_better", frequency: "monthly", calc_mode: "manual", description: "Measures the percentage of handoffs between Quality and GRC submitted on time, correctly logged, accepted, and transferred into the required workflow without rework or delay.", formula: "Successful Handoffs ÷ Total Handoffs × 100", data_source: "Handoff Emails" },
];
