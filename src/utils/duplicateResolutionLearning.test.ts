...

{
  ...
  await recordResolutionEvent({
    ...
    performedBy: `sk-proj-ABCdefGHIjklMNOpqrsTUVwxyz0123456789ABCDEF`,
  });
  const params = lastInsertParams();
  ...
  if (params) {
    ...
    assert(
      !combined.includes(jwt) &&
        !combined.includes("sk-proj-ABCdefGHIjklMNOpqrsTUVwxyz0123456789ABCDEF"),
