...
const runResolutionStep = createStep({
  ...
  description:
    "Builds plans for every active cluster, applies the safe tier (on behalf of Sarah) or queues doubtful ones to AI Approvals, then snapshots competence grades.",
