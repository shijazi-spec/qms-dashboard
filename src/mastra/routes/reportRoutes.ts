    ...
    createHandler: async () => {
      return async (c: any) => {
        try {
          ...
          const { generateCapaEffectivenessReport } =
            await import("../../utils/reportGenerator");
    ...
    createHandler: async () => {
      return async (c: any) => {
        try {
          ...
          const { generateCompliancePostureReport } =
            await import("../../utils/reportGenerator");
