    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, listPMPProjects } = await import("../../utils/teamDatabase");
          ...
          const result = await listPMPProjects({ department, status, priority, projectType, managerId, limit, offset });
          logger?.info("✅ [PMP API] Projects fetched", { count: result.projects.length });
          return c.json(result);
        } catch (error) {
          console.error("Error fetching PMP projects:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          logger?.info("➕ [PMP API] Creating PMP project", { name: body.project_name });

          const { initTeamTables, createPMPProject, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          logger?.info("✅ [PMP API] PMP project created", { id: project.project_id });
          return c.json({ success: true, project });
        } catch (error) {
          console.error("Error creating PMP project:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, getPMPProjectById, listProjectRisks, listProjectMilestones, listProjectStakeholders, listProjectProcurement, listProjectChangeRequests } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          const [risks, milestones, stakeholders, procurement, changeRequests] = await Promise.all([
          ...
          logger?.info("✅ [PMP API] PMP project fetched with details", { projectId });
          return c.json({
            ...project,
            risks: risks.risks,
          ...
          console.error("Error fetching PMP project:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, getPMPProjectById, updatePMPProject, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          console.error("Error updating PMP project:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, getPMPProjectById, deletePMPProject, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          console.error("Error deleting PMP project:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, listProjectRisks } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          const result = await listProjectRisks({ projectId, category, status, ownerId, limit, offset });
          logger?.info("✅ [PMP API] Risks fetched", { count: result.risks.length });
          return c.json(result);
        } catch (error) {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const body = await c.req.json();
          logger?.info("➕ [PMP API] Creating project risk", { title: body.title });

          const { initTeamTables, createProjectRisk, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, getProjectRiskById } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, getProjectRiskById, updateProjectRisk, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, getProjectRiskById, deleteProjectRisk, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, listProjectMilestones } = await import("../../utils/teamDatabase");
          await initTeamTables();

          const url = new URL(c.req.url);
          const projectId = url.searchParams.get("project_id") || undefined;
          const status = url.searchParams.get("status") || undefined;
          const milestoneType = url.searchParams.get("milestone_type") || undefined;
          const ownerId = url.searchParams.get("owner_id") || undefined;
          const limit = parseInt(url.searchParams.get("limit") || "50");
          const offset = parseInt(url.searchParams.get("offset") || "0");

          const result = await listProjectMilestones({ projectId, status, milestoneType, ownerId, limit, offset });
          logger?.info("✅ [PMP API] Milestones fetched", { count: result.milestones.length });
          return c.json(result);
        } catch (error) {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const body = await c.req.json();
          logger?.info("➕ [PMP API] Creating project milestone", { name: body.name });

          const { initTeamTables, createProjectMilestone, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          logger?.info("✅ [PMP API] Milestone created", { id: milestone.milestone_id });
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          logger?.info("📖 [PMP API] Fetching project milestone", { milestoneId });

          const { initTeamTables, getProjectMilestoneById } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const milestoneId = c.req.param("milestoneId");
          const body = await c.req.json();
          logger?.info("✏️ [PMP API] Updating project milestone", { milestoneId });

          const { initTeamTables, getProjectMilestoneById, updateProjectMilestone, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const milestoneId = c.req.param("milestoneId");
          logger?.info("🗑️ [PMP API] Deleting project milestone", { milestoneId });

          const { initTeamTables, getProjectMilestoneById, deleteProjectMilestone, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, listProjectStakeholders } = await import("../../utils/teamDatabase");
          await initTeamTables();

          const url = new URL(c.req.url);
          const projectId = url.searchParams.get("project_id") || undefined;
          const stakeholderType = url.searchParams.get("stakeholder_type") || undefined;
          const influence = url.searchParams.get("influence") || undefined;
          const quadrant = url.searchParams.get("quadrant") || undefined;
          const limit = parseInt(url.searchParams.get("limit") || "50");
          const offset = parseInt(url.searchParams.get("offset") || "0");

          const result = await listProjectStakeholders({ projectId, stakeholderType, influence, quadrant, limit, offset });
          logger?.info("✅ [PMP API] Stakeholders fetched", { count: result.stakeholders.length });
          return c.json(result);
        } catch (error) {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const body = await c.req.json();
          logger?.info("➕ [PMP API] Creating project stakeholder", { name: body.name });

          const { initTeamTables, createProjectStakeholder, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          logger?.info("✅ [PMP API] Stakeholder created", { id: stakeholder.stakeholder_id });
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          logger?.info("📖 [PMP API] Fetching project stakeholder", { stakeholderId });

          const { initTeamTables, getProjectStakeholderById } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          console.error("Error fetching project stakeholder:", error);
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const stakeholderId = c.req.param("stakeholderId");
          const body = await c.req.json();
          logger?.info("✏️ [PMP API] Updating project stakeholder", { stakeholderId });

          const { initTeamTables, getProjectStakeholderById, updateProjectStakeholder, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();

          const oldStakeholder = await getProjectStakeholderById(stakeholderId);
          const stakeholder = await updateProjectStakeholder(stakeholderId, body);
          if (!stakeholder) {
            return c.json({ error: "Project stakeholder not found" }, 404);
          }
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const stakeholderId = c.req.param("stakeholderId");
          logger?.info("🗑️ [PMP API] Deleting project stakeholder", { stakeholderId });

          const { initTeamTables, getProjectStakeholderById, deleteProjectStakeholder, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, getProjectPortfolioAnalytics } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const projectId = c.req.param("projectId");
          logger?.info("📅 [PMP API] Fetching project Gantt data", { projectId });

          const { initTeamTables, getProjectGanttData } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const body = await c.req.json();
          logger?.info("🤖 [PMP API] Generating AI project charter", { projectName: body.project_name });
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, listProjectProcurement } = await import("../../utils/teamDatabase");
          await initTeamTables();

          const url = new URL(c.req.url);
          const projectId = url.searchParams.get("project_id") || undefined;
          const status = url.searchParams.get("status") || undefined;
          const procurementType = url.searchParams.get("procurement_type") || undefined;
          const vendorName = url.searchParams.get("vendor_name") || undefined;
          const limit = parseInt(url.searchParams.get("limit") || "50");
          const offset = parseInt(url.searchParams.get("offset") || "0");

          const result = await listProjectProcurement({ projectId, status, procurementType, vendorName, limit, offset });
          logger?.info("✅ [PMP API] Procurement records fetched", { count: result.procurement.length });
          return c.json(result);
        } catch (error) {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const body = await c.req.json();
          logger?.info("➕ [PMP API] Creating procurement record", { title: body.title });

          const { initTeamTables, createProjectProcurement, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          logger?.info("✅ [PMP API] Procurement created", { id: procurement.procurement_id });
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          logger?.info("📖 [PMP API] Fetching procurement record", { procurementId });

          const { initTeamTables, getProjectProcurementById } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const procurementId = c.req.param("procurementId");
          const body = await c.req.json();
          logger?.info("✏️ [PMP API] Updating procurement record", { procurementId });

          const { initTeamTables, getProjectProcurementById, updateProjectProcurement, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();

          const oldProcurement = await getProjectProcurementById(procurementId);
          const procurement = await updateProjectProcurement(procurementId, body);
          if (!procurement) {
            return c.json({ error: "Procurement record not found" }, 404);
          }
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const procurementId = c.req.param("procurementId");
          logger?.info("🗑️ [PMP API] Deleting procurement record", { procurementId });

          const { initTeamTables, getProjectProcurementById, deleteProjectProcurement, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const { initTeamTables, listProjectChangeRequests } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          const result = await listProjectChangeRequests({ projectId, status, changeType, priority, limit, offset });
          logger?.info("✅ [PMP API] Change requests fetched", { count: result.changeRequests.length });
          return c.json(result);
        } catch (error) {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const body = await c.req.json();
          logger?.info("➕ [PMP API] Creating change request", { title: body.title });

          const { initTeamTables, createProjectChangeRequest, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          logger?.info("✅ [PMP API] Change request created", { id: changeRequest.change_request_id });
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          logger?.info("📖 [PMP API] Fetching change request", { changeRequestId });

          const { initTeamTables, getProjectChangeRequestById } = await import("../../utils/teamDatabase");
          await initTeamTables();

          const changeRequest = await getProjectChangeRequestById(changeRequestId);
          if (!changeRequest) {
            return c.json({ error: "Change request not found" }, 404);
          }

          logger?.info("✅ [PMP API] Change request fetched", { changeRequestId });
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          const changeRequestId = c.req.param("changeRequestId");
          const body = await c.req.json();
          logger?.info("✏️ [PMP API] Updating change request", { changeRequestId });

          const { initTeamTables, getProjectChangeRequestById, updateProjectChangeRequest, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();

          const oldChangeRequest = await getProjectChangeRequestById(changeRequestId);
          const changeRequest = await updateProjectChangeRequest(changeRequestId, body);
          if (!changeRequest) {
            return c.json({ error: "Change request not found" }, 404);
          }
          ...
          logger?.info("✅ [PMP API] Change request updated", { changeRequestId });
          return c.json({ success: true, changeRequest });
        } catch (error) {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          const logger = mastra?.getLogger();
          const changeRequestId = c.req.param("changeRequestId");
          logger?.info("🗑️ [PMP API] Deleting change request", { changeRequestId });

          const { initTeamTables, getProjectChangeRequestById, deleteProjectChangeRequest, logAuditEntry } = await import("../../utils/teamDatabase");
          await initTeamTables();
          ...
          logger?.info("✅ [PMP API] Change request deleted", { changeRequestId });
          return c.json({ success: true });
        } catch (error) {
    ...
    createHandler: async ({ mastra }: any) => {
      return async (c: any) => {
        try {
          ...
          return c.text(`Projects dashboard not found. Searched paths: ${possiblePaths.join(", ")}`, 404);
        } catch (error) {
          console.error("Error loading Projects dashboard:", error);
