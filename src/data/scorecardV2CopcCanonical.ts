...
export const CANONICAL_COPC_V2 = {
  "scorecard": {
    "id": "walaplus_copc_v2",
    "name": "WalaPlus SDR QA Scorecard — COPC-aligned",
    "version": "2.0.0",
  ...
  "_migration_notes": {
    ...
    "ui_changes_required": [
      ...
      "Active Scorecard line should read 'WalaPlus SDR QA Scorecard — COPC-aligned v2.0' instead of 'WalaaPlus Sales Quality Scorecard v1.5'"
    ]
  }
} as const;
