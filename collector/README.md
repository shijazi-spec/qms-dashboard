# WalaPlus Documentation Collector
...
[Environment]::SetEnvironmentVariable('DOC_TRACKER_API_BASE', 'https://qms-dashboard.replit.app', 'Machine')
```
...
```
[2026-07-29 06:00:03] [INFO] Snapshot: 168 document(s), 47.2 KB
[2026-07-29 06:00:05] [INFO] Server accepted snapshot: status=applied inserted=14 updated=3 removed=0 orphans=150
```
...
Invoke-RestMethod -Uri 'https://qms-dashboard.replit.app/api/documentation-tracker/collector-config' -Headers $h
```
