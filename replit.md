...
- Slack trigger registered (Apr 2026): registerSlackTrigger in apiRoutes of index.ts. Webhook at /webhooks/slack/action (public path, rate-limited), diagnostic at /test/slack. Handler forwards messages to qualitySpecialistAgent and replies in thread. Challenge response moved before getClient() call for URL verification. Requires Slack connector in Replit integrations.
